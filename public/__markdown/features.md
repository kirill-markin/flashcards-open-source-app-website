...
- **Offline-First Roadmap** - The repository is designed around local-first clients with backend sync. iOS is the next planned client, with Android following later.
