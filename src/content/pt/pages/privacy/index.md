...
Separadamente, os links de instalação do catálogo enviam um evento de clique para o nosso próprio coletor de análise de produto, com o identificador público da versão do pacote, o idioma da interface da página, o idioma do dispositivo no navegador, a posição do link, a categoria de origem, a categoria do dispositivo e o identificador `analytics_visitor` descrito abaixo quando o seu navegador o tem. Esse coletor não deduz o país a partir do clique. Quando o navegador expõe o Global Privacy Control ou o Do Not Track, o site não envia nenhum evento de clique para esse coletor, não pede nenhum identificador de visitante e não exibe o aviso de consentimento.
