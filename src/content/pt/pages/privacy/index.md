...
Separadamente, o site envia eventos para o nosso próprio coletor de análise de produto: um evento de visualização de página para cada página que você abre e um evento de clique quando você segue um link para o aplicativo web, para uma loja de aplicativos ou para instalar um baralho do catálogo. Conforme o evento, eles trazem o tipo de página, o identificador público da versão do pacote nas páginas de baralhos do catálogo e nos links de instalação, a posição do link, o idioma da interface da página, o idioma do dispositivo no navegador, a categoria de origem, a categoria do dispositivo e o identificador `analytics_visitor` descrito abaixo quando o seu navegador o tem. Esse coletor não deduz o país a partir desses eventos. Quando o navegador expõe o Global Privacy Control ou o Do Not Track, o site não envia nenhum evento para esse coletor, não pede nenhum identificador de visitante e não exibe o aviso de consentimento.
