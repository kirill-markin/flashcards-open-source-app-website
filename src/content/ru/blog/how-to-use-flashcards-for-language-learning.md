...
Карточки для системы письма могут использовать тот же двусторонний подход и при этом оставаться предельно узкими. [Колода со всеми 46 базовыми знаками хираганы и ромадзи](/catalog/packages/basic-hiragana-romaji/) содержит ровно 92 карточки по всем 46 современным базовым знакам хираганы: половина проверяет направление «кана → учебная ромадзи в стиле Хепбёрна», другая — «ромадзи → кана». В ней нет аудио, лексики, порядка черт, дакутэна и сочетаний с маленькими я, ю и ё, поэтому это точечная база, а не полный курс японского.
