...
## Чем здесь действительно помогает Nibomo

[Возможности Nibomo](/features/) покрывают простую часть этого процесса: создание карточек с лицевой и обратной сторонами, повторение карточек по расписанию и планирование интервалов с помощью FSRS. Для пяти форматов выше не нужен специальный шаблон AP.
