...
[Nibomo](https://flashcards-open-source-app.com/ru/) хорошо подходит для такой подготовки к экзамену, потому что продукт поддерживает обе половины задачи и не делает вид, что это одно и то же.
