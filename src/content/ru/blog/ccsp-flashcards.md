...
Среди [возможностей Nibomo](/features/) — создание карточек с лицевой и обратной сторонами, AI-чат с данными рабочего пространства и поддерживаемыми файловыми вложениями, а также повторение по FSRS с оценками Again, Hard, Good и Easy.
