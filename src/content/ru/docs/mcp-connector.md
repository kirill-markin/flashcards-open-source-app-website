---
title: MCP-коннектор
description: "Подключите удалённый MCP-сервер Nibomo как пользовательский коннектор: OAuth для клиентов, API-ключ для headless-сценариев и раздельные SQL-инструменты чтения и записи."
---

## Обзор

Nibomo предоставляет удалённый MCP-сервер (Model Context Protocol), чтобы
