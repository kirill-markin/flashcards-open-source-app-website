...
description: Запустите Nibomo локально с PostgreSQL, аутентификацией, бэкендом, веб-приложением и приложением для администраторов или разверните описанный рабочий стек AWS CDK.
---

Nibomo поддерживает два разных варианта: локальную среду разработки и рабочее развёртывание в AWS. Docker Compose запускает PostgreSQL и миграции для локальной разработки; для рабочего развёртывания он не используется.
