...
4. Агент загружает `/v1/agent/me`, получает список рабочих пространств, при необходимости выбирает одно и затем использует `/v1/agent/sql/query` и `/v1/agent/sql/execute`.
