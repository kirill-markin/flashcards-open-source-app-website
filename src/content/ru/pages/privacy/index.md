...
Отдельно ссылки установки из каталога отправляют событие клика в нашу собственную аналитику продукта: с публичным идентификатором версии пакета, языком интерфейса страницы, языком устройства из браузера, местом ссылки, категорией источника перехода, категорией устройства и описанным ниже идентификатором `analytics_visitor`, если браузер его хранит. Этот обработчик не определяет страну по клику. Если браузер сообщает Global Privacy Control или Do Not Track, сайт не отправляет события кликов, не запрашивает идентификатор посетителя и не показывает баннер согласия.
