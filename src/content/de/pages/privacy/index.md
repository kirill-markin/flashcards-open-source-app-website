...
Unabhängig davon sendet die Website Ereignisse an unsere eigene Produktanalyse: ein Seitenaufrufereignis für jede Seite, die Sie öffnen, und ein Klickereignis, wenn Sie einem Link in die Web-App, in einen App Store oder zur Installation eines Katalog-Decks folgen. Je nach Ereignis enthalten sie den Seitentyp, auf Katalog-Deckseiten und bei Installationslinks die öffentliche Paketversionskennung, die Linkposition, die Sprache der Seitenoberfläche, die Gerätesprache des Browsers, die Herkunftskategorie, die Gerätekategorie und die unten beschriebene Kennung `analytics_visitor`, sofern Ihr Browser eine trägt. Dieser Empfänger leitet aus diesen Ereignissen kein Land ab. Signalisiert der Browser Global Privacy Control oder Do Not Track, sendet die Website kein Ereignis an diesen Empfänger, fordert keine Besucherkennung an und zeigt keinen Einwilligungsbanner.
...
Die Marketing-Website und die gehostete Web-App teilen sich ein eigenes Analyse-Cookie namens `analytics_visitor`. Es enthält eine zufällige Besucherkennung, ist für unsere Skripte im Browser lesbar und läuft nach 13 Monaten ab. Damit erkennen wir denselben Browser über mehrere Besuche hinweg, sodass Ereignisse einen wiederkehrenden Besucher zeigen und nicht jedes Mal einen neuen. Dieses Cookie ist nicht technisch notwendig. Diese Entscheidung betrifft nur, ob Ihr Browser diese Kennung trägt; ob die Website überhaupt etwas erfasst, regelt ein gesonderter Schalter, der weiter unten beschrieben wird. Wo eine Einwilligung erforderlich ist, darunter in der EU/im EWR und im Vereinigten Königreich, setzen wir es erst nach Ihrer Zustimmung: Die Website fragt mit einem Banner; bis zu Ihrer Antwort fordert sie keine Kennung an und fügt keine hinzu, während die oben beschriebenen Seitenaufruf- und Klickereignisse weiterhin ohne diese Kennung gesendet werden und nur die im nächsten Absatz beschriebene Tageskennung erhalten. Wo keine Einwilligung erforderlich ist, setzen wir es ohne Nachfrage. In beiden Fällen können Sie es jederzeit abschalten, über das Analyse-Bedienelement in der Ecke jeder Seite der Website oder in den Einstellungen der Web-App; wir löschen das Cookie dann aus Ihrem Browser und verwenden es nicht weiter. Ihre Antwort wird in Ihrem Browser gespeichert, damit Sie nicht erneut gefragt werden. Die Ereignisse selbst bewahren wir so lange auf, wie wir sie für die hier beschriebenen Zwecke benötigen.

Erreicht ein Seitenaufruf- oder Klickereignis unseren Empfänger ohne die `analytics_visitor`-Kennung, etwa weil Sie das Cookie abgelehnt, noch nicht geantwortet oder es abgeschaltet haben, bildet unser Server eine vorübergehende Kennung aus der IP-Adresse und dem User-Agent des Browsers der Anfrage, kombiniert mit einem Zufallswert, der sich an jedem UTC-Tag ändert und nach Ablauf dieses Tages gelöscht wird. Die IP-Adresse selbst speichern wir nicht in unserer Analyse. Diese Kennung verknüpft nur die Seitenaufrufe und Klicks desselben Tages aus demselben Browser mit derselben IP-Adresse. Sie wird nie in Ihrem Browser gespeichert, nie mit der `analytics_visitor`-Kennung oder einem Konto verknüpft, nie einer Aufzeichnung Ihrer Einwilligungsantwort beigefügt und lässt sich nicht mehr neu berechnen, sobald der Zufallswert dieses Tages gelöscht ist. Wir nutzen sie, um zu verstehen, wie Besucher die Website nutzen, auf Grundlage unseres berechtigten Interesses, wie im Abschnitt Zwecke und Rechtsgrundlagen beschrieben. Signalisiert Ihr Browser Global Privacy Control oder Do Not Track, sendet die Website nichts an diesen Empfänger, sodass auch keine solche Kennung gebildet wird.

Das Analyse-Bedienelement in der Ecke jeder Seite der Website enthält den Schalter, der die Erfassung dieser Website abschaltet, und daneben die oben beschriebene Einwilligung in das Analyse-Cookie; sobald Sie das Banner beantwortet haben, enthält das Bedienelement auch diese Cookie-Entscheidung, solange die Erfassung an ist, und bietet sie erneut an, wenn Sie die Erfassung wieder einschalten. Solange die Erfassung aus ist, sendet die Website kein Seitenaufruf- und kein Klickereignis über Ihren Besuch, weder an unseren Empfänger noch an Vercel Web Analytics, und fordert keine Besucherkennung an; da nichts unseren Empfänger erreicht, wird auch keine Tageskennung gebildet. Sie ist an, sofern Sie sie nicht ausschalten, auf Grundlage des berechtigten Interesses, das im Abschnitt Zwecke und Rechtsgrundlagen beschrieben ist. Diese Website hat keine Konten, daher wird Ihre Antwort in diesem Browser gespeichert und wirkt nur dort; die gehostete Web-App hat ihre eigene Einstellung, und die iOS- und die Android-App haben sie ab der App-Version, die sie einführt, beide beschrieben im Abschnitt Produktanalyse.
