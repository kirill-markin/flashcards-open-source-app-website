---
title: "AP-Statistics-Lernkarten 2027: Die neue Prüfung mit fünf Units"
description: "Überarbeite deine AP-Statistics-Lernkarten für die Prüfung 2027: Prüfe alte Decks, decke alle fünf Units ab und übe FRQ-Begründungen an vollständigen Aufgaben."
date: "2026-09-09"
image: "/blog/ap-statistics-flashcards.png"
keywords:
  - "AP-Statistics-Lernkarten"
  - "AP-Stats-Lernkarten"
  - "AP Statistics 2027"
  - "AP-Statistics-Lernhilfe"
  - "AP-Statistics-Units"
  - "AP Statistics FRQ"
  - "AP-Statistics-Prüfung 2027"
  - "AP Statistics fünf Units"
---
...
![Eine Schülerin untersucht fünf ökologische Probeflächen auf einer Wiese](/blog/ap-statistics-flashcards.png)

## Prüfe alte AP-Statistics-Lernkarten, bevor du neue erstellst

Die [Überarbeitung von AP Statistics durch College Board ist seit dem Schuljahr 2026–27 in Kraft](https://apcentral.collegeboard.org/courses/ap-statistics/future-revisions). Die früheren Units 1–8 wurden zu fünf Units zusammengefasst, die bisherige Unit 9 entfiel. Hinzu kamen Themen rund um Untersuchungsfragen.

Maßgeblich ist die [ab Herbst 2026 geltende Course and Exam Description](https://apcentral.collegeboard.org/media/pdf/ap-statistics-course-and-exam-description-effective-fall-2026.pdf) – selbst wenn ein geteiltes Deck schon „2027“ im Titel trägt.

Prüfe jedes übernommene Deck in vier Schritten:

1. **Ignoriere die alten Unit-Nummern.** Eine Karte mit dem Tag `Unit 4` gehört nicht automatisch in die aktuelle Unit 4. Ordne sie anhand ihres Inhalts einer neuen Unit und einem konkreten Thema zu.
2. **Sondere gestrichenen Stoff aus.** Nicht mehr zum Kurs gehören die Analyse von Abweichungen von Linearität, das Kombinieren von Zufallsvariablen, die geometrische Verteilung, der Chi-Quadrat-Anpassungstest sowie die ehemalige Unit 9 zur Inferenz für Regressionssteigungen.
3. **Schließe die tatsächlich neuen Lücken.** Achte besonders darauf, ob dein Deck Untersuchungsfragen abdeckt und nicht nur Definitionen und Berechnungen.
4. **Prüfe auch die Formulierung.** Lösche doppelte Karten, teile Fragen zu mehreren unverbundenen Fakten auf und formuliere Antworten um, die du nicht eindeutig als richtig oder falsch bewerten kannst.
...
Ein neues Tag rettet keine vage Karte. Wenn dir beim Prüfen überladene Definitionen oder passive „lesen und wiedererkennen“-Fragen auffallen, findest du in [Bessere Lernkarten erstellen](/blog/how-to-make-better-flashcards/) konkrete Beispiele zum Überarbeiten.
...
Wenn das Erstellen des Decks langsam das eigentliche Üben verdrängt, grenzt [Lernkarten vs. Übungstests](/blog/flashcards-vs-practice-tests/) die Aufgaben beider Werkzeuge klar voneinander ab.
...
Die [AP-Statistics-Prüfung 2027](https://apcentral.collegeboard.org/courses/ap-statistics/exam) dauert drei Stunden. Abschnitt I umfasst **42 Multiple-Choice-Fragen in 90 Minuten** und zählt **50 %** der Gesamtpunktzahl. Abschnitt II umfasst **vier Free-Response-Fragen mit je 10 Punkten in 90 Minuten** und zählt ebenfalls **50 %**.

Die vier FRQs setzen unterschiedliche Schwerpunkte:

1. **Frage 1:** mehrere Schwerpunkte aus Formulate Questions und Collect Data.
2. **Frage 2:** mehrere Schwerpunkte aus Analyze Data und Interpret Results.
3. **Frage 3:** Inferenz mithilfe eines Hypothesentests oder Konfidenzintervalls.
4. **Frage 4:** mehrere Schwerpunkte aus Collect Data, Analyze Data und Interpret Results über verschiedene Inhaltsbereiche hinweg.
...
Laut dem [AP-Prüfungskalender 2027](https://apstudents.collegeboard.org/exam-dates) von College Board findet die Prüfung am **Dienstag, 11. Mai 2027, in Session 2** statt. Sie ist vollständig digital: Beide Abschnitte und sämtliche Free-Response-Antworten werden in Bluebook bearbeitet.
...
1. **Nach dem Unterricht:** Ergänze einige Karten zu neuen Abgrenzungen, Verfahrensentscheidungen, Voraussetzungen und Interpretationsmustern.
2. **Nach der Arbeit mit dem Taschenrechner:** Übe jeden Befehl und jede Ausgabe, mit denen du noch nicht sicher umgehen konntest. Nur die dahinterstehende Entscheidung gehört auf eine Karte.
3. **Nach MCQ-Übungen:** Verwandle wiederkehrende Verständnisfehler in Karten. Einmalige Lesefehler kommen in ein kurzes Übungsprotokoll.
4. **Nach einer FRQ:** Erstelle höchstens drei Karten, die Fehler in Regeln übersetzen. Bearbeite danach eine andere Aufgabe mit derselben Art von Begründung.
5. **Einmal pro Woche:** Filtere nach Unit und Practice, finde schwach abgedeckte Bereiche und entferne Duplikate oder veraltete Karten aus der Zeit vor 2027.
6. **Je näher der Mai rückt:** Erstelle weniger neue Karten und verlagere deine Zeit auf gemischte, zeitlich begrenzte und digitale Übungen.
