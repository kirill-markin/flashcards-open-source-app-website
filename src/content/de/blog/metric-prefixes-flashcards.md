---
title: "Flashcards für metrische Präfixe: alle 24 SI-Präfixe 2026 lernen"
description: "Lerne mit Flashcards alle 24 aktuellen SI-Präfixe: exakte Symbole, Zehnerpotenzen, das griechische μ, Fallen bei Groß- und Kleinschreibung und einen praktischen Ablauf für Umrechnungen."
date: "2026-09-04"
image: "/blog/metric-prefixes-flashcards.png"
keywords:
  - "metrische präfixe flashcards"
  - "si-präfixe tabelle"
  - "metrische präfixe zehnerpotenzen"
  - "metrische präfixe auswendig lernen"
  - "mikrozeichen"
  - "quetta und quecto"
  - "einheiten umrechnen flashcards"
---
...
![Flashcards zu metrischen Präfixen, angeordnet als reziproke Zehnerpotenzen von quetta und quecto bis zur Einheit ohne Präfix](/blog/metric-prefixes-flashcards.png)

## Alle SI-Präfixe in einer Tabelle

Die [BIPM-SI-Broschüre, Version 4.01 vom Juni 2026](https://www.bipm.org/documents/20126/41483022/SI-Brochure-9-EN.pdf) und die [NIST-Tabelle der metrischen Präfixe](https://www.nist.gov/pml/owm/metric-si-prefixes) führen 24 aktuelle Präfixe auf: 12 Vielfache größer als die Einheit und 12 Teilvielfache kleiner als die Einheit. Für `10^0` gibt es kein Präfix. Diese Zeile wäre die Einheit selbst, ganz ohne Präfix.
...
Quetta, `Q`, und quecto, `q`, stehen an den Endpunkten `10^30` und `10^-30`. Ronna, `R`, und ronto, `r`, stehen bei `10^27` und `10^-27`. Die [27. Generalkonferenz für Maß und Gewicht beschloss 2022 alle vier Präfixe](https://www.bipm.org/en/-/resolution-cgpm-27-3) und erweiterte damit die bis dahin geltende Liste aus 20 Präfixen auf 24. Eine Unterrichtstabelle, die bei yotta und yocto aufhört, ist heute unvollständig.
...
Das installierbare Deck [Flashcards zu metrischen Präfixen: alle 24 SI-Namen, Symbole und Zehnerpotenzen](/catalog/packages/metric-prefix-flashcards/) enthält 72 englische Karten: drei Abrufrichtungen für jedes der 24 Präfixe. Sie decken Name, Symbol mit exakter Groß- und Kleinschreibung sowie Zehnerpotenz ab. Das sind genau `24 × 3` und keine 72 verschiedenen Präfixe oder Umrechnungsaufgaben. Nutze das vollständige Deck, wenn du alle Zuordnungen sicher abrufen willst. Erwartet dein Kurs nur eine kleinere Auswahl, beginne damit und erweitere sie, sobald in deinen Aufgaben ein weiteres Präfix auftaucht.
...
Der [Leitfaden für bessere Flashcards](/blog/how-to-make-better-flashcards/) erklärt, warum sich knapp formulierte Vorderseiten und direkte Rückseiten ehrlicher bewerten lassen.
...
Diese Karte hält eine wiederverwendbare Größenprüfung fest. Die Rechnung gehört in Übungsaufgaben. Der [Leitfaden zu Flashcards für fortgeschrittene Chemie](/blog/how-to-use-flashcards-for-advanced-chemistry/) zieht dieselbe Grenze: Stabile Fakten und wiederkehrende Unterscheidungen behältst du mit Karten, vollständige Rechnungen bearbeitest du getrennt.

## Behandle die Einheit mit Präfix als zusammengehöriges Symbol

Nach den BIPM-Regeln bildet ein Präfixsymbol zusammen mit einem Einheitensymbol ein untrennbares Einheitensymbol. Schreib Präfix und Einheit direkt zusammen: `mm`, `μg` und `GHz`. Das Leerzeichen steht zwischen der Zahl und diesem vollständigen Symbol: `5 mm`, nicht `5mm` oder `5 m m`. Der NIST-[Leitfaden zum Schreiben von SI-Einheiten](https://www.nist.gov/pml/owm/writing-si-metric-system-units) nennt dieselbe Regel für Leerzeichen.
...
Nutze die vollständige **Tabelle der SI-Präfixe**, wenn du einen Fakt prüfen musst. Nutze [das Deck mit 72 Karten zu metrischen Präfixen](/catalog/packages/metric-prefix-flashcards/), wenn du Namen, Symbole mit exakter Groß- und Kleinschreibung und Zehnerpotenzen schnell abrufen können willst. Nutze neue Aufgaben, wenn du echte Maßangaben umrechnen musst.
