...
- identifiziere diese Struktur
- wie lautet die Bezeichnung für diese Region
...
- was verbindet A mit B
- was liegt zwischen diesen beiden Regionen
- welche Schicht umgibt diese Struktur
...
Manchmal ist die Quelle:

- ein Screenshot einer Vorlesungsfolie
- ein Whiteboard-Foto
- ein Produkt-UI-Flow
- eine Netzwerkskizze
- ein Architekturdiagramm aus der Doku
...
- Vorderseite: Was passiert in diesem Stoffwechselweg nach der Glykolyse?
- Rückseite: Pyruvat geht in den nächsten Abschnitt der Zellatmung über; unter aeroben Bedingungen führt das in den Citratzyklus.

Oder:

- Vorderseite: Was stellt der Schnittpunkt in einem Standard-Angebots-Nachfrage-Diagramm dar?
- Rückseite: Das Marktgleichgewicht, in dem angebotene und nachgefragte Menge übereinstimmen.
