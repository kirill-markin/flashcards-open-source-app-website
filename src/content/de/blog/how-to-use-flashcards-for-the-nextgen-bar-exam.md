---
title: "Wie du 2026 Flashcards für die NextGen Bar Exam nutzt: Regeln, Issue Spotting und Performance Tasks, die wirklich hängen bleiben"
description: "Du legst 2026 die NextGen Bar Exam ab? Hier ist ein praxisnaher Flashcard-Workflow für Black-Letter-Law, Issue Spotting, Performance Tasks und FSRS, ohne dass dein Deck zu einem zweiten Outline wird."
date: "2026-04-24"
keywords:
  - "NextGen Bar Exam Flashcards"
  - "Flashcards für die NextGen Bar Exam"
...
1. Nach einer Lerneinheit nur die Regeln, Auslöser und wiederkehrenden Fehler festhalten, die wiederverwendbar aussehen.
2. Sie noch am selben oder am nächsten Tag in eine kleine Auswahl möglicher Karten umwandeln.
3. Nach Funktion aufteilen: `rules`, `issue-spotting`, `performance-tasks` oder `practice-misses`.
4. Alles löschen, was eher wie Outline-Rückstand als wie ein klarer Abrufprompt klingt.
...
1. schmalere Karten schreiben
2. Regelkarten von Trigger-Karten und Prozesskarten trennen
3. vage Karten schnell löschen
4. das Volumen neuer Karten realistisch halten
5. FSRS die Planung überlassen, nachdem das Deck überhaupt planenswert ist
