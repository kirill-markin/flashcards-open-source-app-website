...
FSRS kümmert sich um die Termine; du kümmerst dich um den Abruf. Wenn du diesen Zeitplan nutzen möchtest, ohne einen Papierkalender zu verwalten, sieh dir die [Funktionen von Nibomo](/features/) und den [Leitfaden für den Einstieg](/docs/getting-started/) an. Die hilfreiche Routine ist nicht kompliziert: öffnen, abrufen, bewerten, schließen – und morgen wiederkommen.
