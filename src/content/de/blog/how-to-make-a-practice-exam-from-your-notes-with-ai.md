---
title: "Wie du 2026 mit KI eine Probeklausur aus deinen Notizen erstellst: Quellennahe Quizze nutzen, nur Schwachstellen behalten"
description: "Du willst 2026 mit KI eine Probeklausur aus deinen Notizen erstellen? Lade deine Folien, PDFs und Lernzettel hoch, lass ein realistisches Quiz erzeugen, werte die Fehler aus und behalte nur echte Schwachstellen als FSRS-Flashcards."
date: "2026-06-22"
image: "/blog/how-to-make-a-practice-exam-from-your-notes-with-ai.png"
keywords:
  - "probeklausur aus notizen mit ki"
  - "probeklausur aus notizen erstellen"
  - "ki probeklausur aus notizen"
  - "ki quiz aus lernunterlagen"
  - "übungsfragen aus notizen"
  - "mit eigenen notizen per ki lernen"
  - "quellennahe ki zum lernen"
  - "fsrs flashcards"
---

![Warmer Schreibtisch mit quellennaher Probeklausur, Fehlern und ausgewählten Flashcards](/blog/how-to-make-a-practice-exam-from-your-notes-with-ai.png)
...
1. Lade ein kleines, zusammenhängendes Paket an Lernmaterial hoch.
2. Bitte die KI um eine kurze, realistische Probeklausur.
3. Antworte, bevor du Hinweise oder Erklärungen liest.
4. Geh die Fehler und langsamen Antworten durch.
5. Verwandle nur die echten Schwachstellen in Flashcards.
6. Wiederhole diese Karten mit FSRS.
...
Man sieht diese Entwicklung inzwischen klar in öffentlichen Produktentscheidungen. Am **5. Juni 2026** veröffentlichte Meta einen Leitfaden dazu, wie man [Probeklausuren aus hochgeladenem Lernmaterial erstellt](https://ai.meta.com/learn/ai-for-students/how-to-use-ai-to-make-a-practice-exam/). Google war schon vorher in dieselbe Richtung gegangen: NotebookLM bekam im **September 2025** [Flashcards und Quizze](https://blog.google/innovation-and-ai/models-and-research/google-labs/notebooklm-student-features/), brachte diese Funktionen im **November 2025** auch in die mobile App und unterstützte dort ebenfalls [Quizze und Flashcards](https://blog.google/innovation-and-ai/models-and-research/google-labs/notebooklm-app-quizzes-flashcards/). In Googles eigenen [Lerntipps für die Prüfungsphase](https://blog.google/products-and-platforms/products/education/gemini-finals-study-tips/) vom **April 2026** wurde dann ausdrücklich empfohlen, Notizen hochzuladen, um Lernleitfäden, Flashcards und Probeklausuren zu erzeugen. Auch der [Study Mode](https://chatgpt.com/features/study-mode/) von OpenAI ist eher auf geführtes Lernen als auf bloßes Ausspucken von Antworten ausgelegt.
...
Falls dein Material vor der Prüfungsrunde noch aufgeräumt werden muss, beschreibt [Wie du 2026 Notizen in Flashcards verwandelst](/de/blog/turn-notes-into-flashcards/) diese frühere Phase.
...
Für den breiteren Lern-Workflow drumherum ist [So nutzt du KI 2026 zum Lernen](/de/blog/how-to-use-ai-to-study/) der passendere Begleitartikel.
...
Wenn du im nächsten Schritt genau diese Fehler in Karten umwandeln willst, ist [Wie du 2026 Übungsfragen in Flashcards verwandelst](/de/blog/how-to-turn-practice-questions-into-flashcards/) der direkte Begleit-Workflow.
...
- Vorderseite: Wo finden die lichtabhängigen Reaktionen der Photosynthese statt?
  Rückseite: In den Thylakoidmembranen.
- Vorderseite: Wo findet der Calvin-Zyklus statt?
  Rückseite: Im Stroma des Chloroplasten.
...
Wenn du es zum ersten Mal einrichtest, ist [Getting Started](/de/docs/getting-started/) die kürzeste Produkteinführung. Wenn du selbst hosten willst, findest du alles in der [Self-Hosting-Anleitung](/de/docs/self-hosting/). Wenn du rund um dieselben Daten einen Agent-Workflow baust, startest du am besten mit der [API-Referenz](/de/docs/api/).
...
Montag:
Lade einen Foliensatz oder eine Kapitelzusammenfassung hoch und lass eine kurze Probeklausur erzeugen.

Dienstag:
Mach das Quiz ehrlich, ohne früh zu spicken.

Mittwoch:
Geh die Fehler durch und verwandle nur die Schwachstellen in 3 bis 8 neue Flashcards.

Rest der Woche:
Wiederhole fällige Karten mit FSRS und füge keine zweite riesige Ladung hinzu, solange die erste nicht wirklich unter Kontrolle ist.
