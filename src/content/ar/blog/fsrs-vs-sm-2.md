...
إذا كنت تريد **تطبيق بطاقات تعليمية مفتوح المصدر** يتعامل مع جودة الجدولة كقرار أساسي في المنتج لا كخانة إضافية في قائمة الميزات، فقد صُمم [Nibomo](https://flashcards-open-source-app.com/) بهذا الاتجاه.
