...
يدعم [Nibomo](/features/) بطاقات تقليدية ذات وجه أمامي وخلفي، ومجموعات، ووسومًا، ومراجعات مستحقة وفق خوارزمية FSRS بتقييمات `Again` و`Hard` و`Good` و`Easy`. يمكنك تثبيت مجموعة العناصر الـ118، أو إنشاء مجموعة أصغر تطابق ما يطلبه مقررك.
