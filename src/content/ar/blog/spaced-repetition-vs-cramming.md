...
يمكنك اتباع كل خطوة هنا باستخدام الورق وملف ملاحظات وأسئلة تدريبية. وإذا أردت أن يدير FSRS مواعيد البطاقات، فراجع [ميزات Nibomo](/features/) أو [افتح التطبيق المستضاف](https://app.nibomo.com). اختر نمط الدراسة بحسب الموعد النهائي والمدة التي ينبغي أن تبقى فيها المعرفة.
