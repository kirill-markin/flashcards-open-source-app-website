  ...
  sections: [
    {
      ...
      subtitle:
        "تطبيق بطاقات مفتوح المصدر مع تكرار متباعد وتسجيل دخول بلا كلمة مرور ودردشة ذكاء اصطناعي وتدفق إعداد جاهز للوكلاء. استخدم تطبيق الويب المستضاف اليوم، ووصِّل Claude وCursor ووكلاء ذكاء اصطناعي آخرين عبر MCP، وأبقِ الويب وiOS والوكلاء على نموذج الخلفية نفسه.",
      primaryLink: {
        label: "ابدأ الآن",
