...
description: شغّل Nibomo محليًا باستخدام PostgreSQL والمصادقة والخلفية والويب والإدارة، أو انشر مكدس AWS CDK الإنتاجي الموثق.
---

يدعم Nibomo مسارين مختلفين: بيئة تطوير محلية ونشرًا إنتاجيًا على AWS. يشغّل Docker Compose قاعدة PostgreSQL وعمليات الترحيل للتطوير المحلي؛ وهو ليس طريقة النشر في بيئة الإنتاج.
