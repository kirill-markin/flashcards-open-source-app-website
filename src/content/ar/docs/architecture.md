...
4. يحمّل الوكيل `/v1/agent/me`، ويسرد مساحات العمل، ويختار واحدة إذا لزم الأمر، ثم يستخدم `/v1/agent/sql/query` و`/v1/agent/sql/execute`.

## الجدولة

يستخدم Nibomo خوارزمية FSRS كمجدول للمراجعة.
