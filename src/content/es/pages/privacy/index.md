...
Por separado, el sitio web envía eventos a nuestro propio colector de analítica del producto: un evento de vista de página por cada página que abres y un evento de clic cuando sigues un enlace hacia la aplicación web, una tienda de aplicaciones o la instalación de un mazo del catálogo. Según el evento, incluyen el tipo de página, el identificador público de la versión del paquete en las páginas de mazos del catálogo y en los enlaces de instalación, la posición del enlace, el idioma de la interfaz de la página, el idioma del dispositivo indicado por el navegador, la categoría de origen, la categoría de dispositivo y el identificador `analytics_visitor` descrito más abajo cuando tu navegador lo tiene. Este colector no deduce el país a partir de estos eventos. Cuando el navegador señala Global Privacy Control o Do Not Track, el sitio no envía ningún evento a este colector, no solicita ningún identificador de visitante y no muestra el aviso de consentimiento.
