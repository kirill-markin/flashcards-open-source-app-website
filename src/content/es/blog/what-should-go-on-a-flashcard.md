---
title: "Qué debería ir en una flashcard en 2026: un filtro práctico para apuntes, borradores de IA y diapositivas de clase"
description: "Generar flashcards es fácil en 2026. Decidir qué merece de verdad convertirse en tarjeta es la parte difícil. Aquí tienes un filtro práctico para apuntes, borradores de IA, diapositivas de clase y páginas de libros de texto para quedarte con las tarjetas que sí vale la pena repasar con FSRS y dejar fuera el resto."
image: "/blog/what-should-go-on-a-flashcard.png"
date: "2026-06-16"
keywords:
  - "qué debería ir en una flashcard"
  - "cómo decidir qué va en una flashcard"
  - "qué pertenece a una flashcard"
  - "apuntes que merecen flashcards"
  - "flashcards con ia demasiadas tarjetas"
  - "hacer flashcards de cada frase"
  - "cómo filtrar flashcards"
  - "qué apuntes merecen flashcards"
  - "buena selección de flashcards"
---
...
![Mesa de estudio cálida con borradores de flashcards filtrados en una pequeña pila lista para repasar](/blog/what-should-go-on-a-flashcard.png)
...
[Cómo convertir preguntas de práctica en tarjetas didácticas en 2026](/es/blog/how-to-turn-practice-questions-into-flashcards/) funciona muy bien justo por eso. Las preguntas falladas ya te dicen dónde está la fricción.
...
- Anverso: ¿Qué cambia la cantidad demandada sin desplazar la curva de demanda?
  Reverso: Un cambio en el precio del propio bien.
- Anverso: ¿Qué etapa viene después de la metafase en la mitosis?
  Reverso: Anafase.
...
Si la idea merece quedarse, ajústala. [Cómo hacer mejores flashcards en 2026](/es/blog/how-to-make-better-flashcards/) profundiza más en esa parte.
...
[Cuándo hacer flashcards en 2026](/es/blog/when-to-make-flashcards/) explica con más detalle la cuestión del momento, pero la versión corta sigue siendo válida: entiende primero el bloque y luego convierte en tarjetas las partes que todavía se te siguen escapando.
...
Si el lote ya existe y necesita limpieza, [Cómo evitar la sobrecarga de flashcards con IA en 2026](/es/blog/how-to-avoid-ai-flashcard-overload/) y [Cómo corregir flashcards de IA en 2026](/es/blog/how-to-fix-ai-flashcards/) cubren el trabajo de reparación. Este artículo es el filtro que va antes de eso.
...
Si tu punto de partida es material de clase, [Cómo convertir grabaciones de clase en tarjetas didácticas en 2026](/es/blog/how-to-turn-lecture-recordings-into-flashcards/) te ayuda más arriba en el flujo. El paso de selección sigue importando después del borrador.
...
1. Aprende primero un bloque pequeño.
2. Marca los datos, pasos, distinciones y errores que todavía se te escapan.
3. Redacta tarjetas candidatas tú mismo o con ayuda de IA.
4. Borra todo lo trivial, duplicado, vago o dependiente de la fuente.
5. Reescribe las pocas tarjetas que importan pero siguen siendo torpes.
6. Pasa al repaso real solo las que sobrevivan.
...
Eso encaja con lo que el producto ofrece hoy públicamente: creación de tarjetas, chat con IA con archivos adjuntos, organización por mazos y repaso programado. Si lo estás configurando por primera vez, [Primeros pasos](/es/docs/getting-started/) es la ruta más corta.
