...
Flashcards cuenta con [documentación para autoalojar todo el stack en AWS](/es/docs/self-hosting/), pero no es un despliegue genérico que se complete con un solo comando. Quien lo opera se hace cargo de AWS, Cloudflare, la autenticación, la entrega de correo electrónico, la recuperación de la base de datos, la monitorización, las actualizaciones y la compilación y distribución independientes de las aplicaciones nativas. La [guía de Flashcards autoalojado](/es/blog/self-hosted-open-source-flashcards-app-for-spaced-repetition/) ofrece una visión más breve del producto, mientras que [Anki frente a Nibomo](/es/blog/anki-vs-flashcards-open-source-app/) explica las diferencias de madurez y de flujo de trabajo.
