...
Nibomo 真正适合接手的，是你先把有意义的课件内容提取出来之后的那一步。你可以粘贴文本、上传辅助材料、用 AI 对话起草卡片、编辑卡片正反面、按牌组和标签整理，然后用 FSRS 复习。它不会原生吃下一个未经处理的 PowerPoint 或 Google Slides 文件，再自动把它变成高质量卡片。
...
## 提取完成之后，Nibomo 适合接手哪一段

一旦你已经把有意义的课件内容整理成文本，[Nibomo](/zh/features/) 就会接上最关键的那部分：
