---
title: "适用于间隔重复的自托管开源 Flashcards 应用"
description: "想找一款可以自托管的开源 flashcards app？用清晰的复习队列、无密码登录，以及对学习数据的完整掌控来搭建你的间隔重复系统。"
date: "2026-03-08"
keywords:
  - "开源 flashcards app"
  - "自托管 flashcards app"
...
[Flashcards](https://flashcards-open-source-app.com/) 想填补的正是这道空缺：一款可自托管的开源 flashcards app，具备间隔重复、现代 Web 技术栈、离线优先客户端支持，以及从产品方向一开始就纳入其中的 AI，而不是后期硬贴上去的附加功能。
...
在 [Flashcards](https://flashcards-open-source-app.com/) 里，当前的 Web 应用已经把 AI chat 直接接到了真实 workspace 上。更大的整体架构也已经向终端工具暴露了独立的 external agent 接口，而 iOS 客户端则保留了自己的离线优先同步流程。
