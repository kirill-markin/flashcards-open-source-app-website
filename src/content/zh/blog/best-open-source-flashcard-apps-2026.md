...
> **利益披露：** 我是 Kirill Markin，也是下列六款应用之一 [Nibomo](https://nibomo.com/) 的开发者。它采用 MIT 许可证的仓库覆盖 Web 应用、原生客户端、后端、同步和基础设施。我没有把它排在第一。Anki 是更稳妥的默认选择，Mnemosyne 的 Anki 迁移路径更成熟，而且这里还有几款方案运维起来轻松得多。
