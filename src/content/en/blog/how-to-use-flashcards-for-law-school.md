---
title: "How to Use Flashcards for Law School in 2026: Cases, Rules, and Issue Spotting That Actually Stick"
description: "Practical law school flashcards workflow for cases, class notes, outlines, and practice hypos using AI drafting plus FSRS without turning your deck into a second outline."
date: "2026-04-16"
keywords:
  - "law school flashcards"
  - "flashcards for law school"
  - "spaced repetition law school"
  - "law school spaced repetition"
  - "case brief flashcards"
  - "law school outlines to flashcards"
  - "issue spotting flashcards"
  - "practice hypos flashcards"
  - "1L flashcards"
  - "bar exam flashcards"
---
...
| Material | What you actually need to retrieve | What goes wrong with weak cards |
|---|---|---|
| Cases | rule, holding, decisive fact, comparison point | you remember the vibe of the case but not why it matters |
| Black-letter rules | elements, test, trigger, limitation | you recognize the doctrine but cannot produce it cleanly |
| Exceptions and distinctions | boundary line, contrast, common confusion | you collapse two related doctrines into one fuzzy answer |
...
1. identify the rules, tests, and distinctions that are actually exam-relevant
2. pull the sections where you still hesitate or keep mixing up elements
3. draft small candidate cards from those sections
4. delete anything that reads like an outline fragment instead of a retrieval prompt
...
1. After reading or class, capture only the rules, holdings, and distinctions that seem worth remembering.
2. Turn those into a small batch of candidate cards the same day or the next day.
3. Later in the week, add cards from missed hypos, practice essays, or multiple-choice sets.
4. Delete vague cards quickly instead of defending them because you already made them.
5. Review due cards daily and keep new-card volume lower than your ambition.
...
1. make the card narrower
2. delete what does not deserve review
3. keep new-card volume realistic
4. let FSRS handle the scheduling
