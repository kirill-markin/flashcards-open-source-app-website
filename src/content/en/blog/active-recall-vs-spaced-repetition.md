---
title: "Active Recall vs Spaced Repetition in 2026: What to Test Now and What to Review Later"
description: "Active recall vs spaced repetition is not really an either-or choice. Active recall shows what you cannot retrieve yet, and spaced repetition decides which of those misses should come back later in your FSRS review queue."
date: "2026-06-21"
image: "/blog/active-recall-vs-spaced-repetition.png"
keywords:
  - "active recall vs spaced repetition"
  - "active recall or spaced repetition"
  - "difference between active recall and spaced repetition"
...
![Warm desk with active recall cards moving into a spaced repetition review queue](/blog/active-recall-vs-spaced-repetition.png)
...
- [How to Use the Blurting Method With Flashcards in 2026](/blog/how-to-use-the-blurting-method-with-flashcards/)
- [How to Use the Feynman Technique With Flashcards in 2026](/blog/how-to-use-the-feynman-technique-with-flashcards/)
...
If you care about that broader handoff from tutor or notes into review, [How to Use AI to Study in 2026](/blog/how-to-use-ai-to-study/) is the closest companion article.
...
If you want the product entry points after that handoff, start with the [features page](/features/), the [getting started guide](/docs/getting-started/), or the [self-hosting guide](/docs/self-hosting/). If the open-source angle is the main reason you are here, [Self-Hosted Open Source Flashcards App for Spaced Repetition](/blog/self-hosted-open-source-flashcards-app-for-spaced-repetition/) is the more direct read.
