---
title: "How to Use Flashcards for CFA Level II in 2026: Item Sets, LOS Tags, and Mock-Exam Misses That Actually Stick"
description: "Preparing for CFA Level II in 2026? Use this practical flashcards workflow for item sets, LOS tags, formula interpretation, CFA Institute practice questions and mocks, and FSRS review."
...
If you want the Level I version of this workflow first, [How to Use Flashcards for CFA Level I in 2026](/blog/how-to-use-flashcards-for-cfa-level-1/) is the right companion article. Level I is more direct. Level II gets more interpretive, more case-based, and less forgiving of fuzzy recall.

## Use the 2026 topic weights as a review budget

The official [2026 Level II exam page](https://www.cfainstitute.org/programs/cfa-program/candidate-resources/level-ii-exam) publishes the current topic weights. I would treat those weights as a review budget, not as a command to create cards for every reading.
...
The official [2026 Level II topic outline PDF](https://www.cfainstitute.org/sites/default/files/docs/programs/cfa-program/2026-l2-topics-combined.pdf) lists the current readings and learning outcomes. Use that structure directly. Instead of tagging a card only as `equity` or `fixed-income`, tag it by the LOS or reading, the topic, and the kind of miss.
...
If your deck organization is already getting messy, [How to Organize Flashcards in 2026](/blog/how-to-organize-flashcards/) is worth reading before the card count gets bigger.
...
1. a formula card
   Front: What is the justified forward P/E relationship based on fundamentals?
   Back: It links expected payout, required return, and expected growth in a Gordon-style setup.

2. an input-selection card
   Front: In a justified multiple vignette, which input mistake shows up most often?
   Back: Pulling the observed market multiple or historical figure instead of the model input implied by the assumptions in the case.

3. an interpretation card
   Front: If required return rises and expected growth stays unchanged, what happens to justified forward P/E?
   Back: It falls because the denominator widens relative to growth.
...
The official [CFA candidate resources page](https://www.cfainstitute.org/programs/cfa-program/candidate-resources) says the Learning Ecosystem for the February 2026 exam includes the curriculum, practice questions, mock exams, study planner, flashcards, and Practical Skills Modules. That gives you plenty of material.
...
If you want the broader workflow for converting missed questions into cards, [How to Turn Practice Questions Into Flashcards in 2026](/blog/how-to-turn-practice-questions-into-flashcards/) goes deeper on the extraction process.
...
If you are new to the app workflow, the [getting started guide](/docs/getting-started/) covers the basics, and the [features page](/features/) shows the pieces that matter here: card editing, tags, and FSRS review inside the same product.
...
- [FSRS Settings in 2026](/blog/fsrs-settings/)
