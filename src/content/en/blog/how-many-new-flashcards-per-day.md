---
title: "How Many New Flashcards Per Day in 2026? Build an FSRS Review Load You Can Actually Finish"
description: "Wondering how many new flashcards per day is sustainable? Here is a practical 2026 rule: start from available review time, not ambition, then set a daily new-card limit you can actually finish without drowning in due reviews."
date: "2026-03-31"
keywords:
  - "how many new flashcards per day"
  - "how many flashcards a day"
...
1. choose a daily review time you can sustain for two weeks
2. set a small new-card limit
3. watch how many due reviews show up after a few days
4. increase only if the queue still feels easy
5. decrease immediately if you start postponing reviews
...
|---|---|
| Busy schedule, difficult subject | 5 to 10 new cards per day |
| Normal schedule, decent card quality | 10 to 20 new cards per day |
| Dedicated study block, simple cards, stable reviews | 20 to 30 new cards per day |
...
1. generate candidate cards in NotebookLM or ChatGPT
2. clean them up
3. move them into a spaced repetition app
