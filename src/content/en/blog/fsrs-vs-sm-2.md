...
If you want an **open source flashcards app** that treats scheduling quality like a core product decision instead of a checkbox, [Nibomo](https://flashcards-open-source-app.com/) is built in that direction.
