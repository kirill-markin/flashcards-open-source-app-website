---
title: "How to Use the Feynman Technique With Flashcards in 2026: Explain It Simply, Then Let FSRS Keep It"
description: "Use the Feynman technique with flashcards in 2026: explain a topic in plain language, turn only the weak spots into small cards, and let FSRS handle the follow-up."
image: "/blog/how-to-use-the-feynman-technique-with-flashcards.png"
date: "2026-06-20"
keywords:
  - "feynman technique flashcards"
  - "how to use the feynman technique"
  - "feynman technique with flashcards"
  - "teach back study method"
  - "self explanation study method"
  - "active recall explanation method"
  - "explain concepts with flashcards"
...
![Warm desk scene showing a plain-language explanation turning into a few focused FSRS flashcards](/blog/how-to-use-the-feynman-technique-with-flashcards.png)
...
- [What Should Go on a Flashcard in 2026?](/blog/what-should-go-on-a-flashcard/)
...
- Front: In the nephron, where does most reabsorption happen?
  Back: The proximal convoluted tubule.
- Front: What is the difference between glomerular filtration and tubular secretion?
  Back: Filtration moves substances from blood into the nephron at the glomerulus. Secretion moves selected substances from peritubular blood into the tubule later.
- Front: Why does the loop of Henle matter for urine concentration?
  Back: It creates the concentration gradient that helps the kidney reabsorb water more effectively.
...
If you want the quickest path into the hosted app, [Getting Started](/docs/getting-started/) covers it. If you want a shorter product overview first, [Features](/features/) is the right page.

## A Feynman-to-flashcards workflow that survives a normal week

This is the version I would actually repeat:

1. Study one small topic.
2. Hide the source.
3. Explain the topic out loud in plain language.
4. Mark every place where you stalled, got vague, mixed up a term, or could not give an example.
5. Check the source and fix your understanding.
6. Turn only the weak spots into small cards.
7. Add the cards to the right deck or tag.
8. Let FSRS schedule the follow-up.
...
If the queue starts feeling noisy, [How Many New Flashcards Per Day in 2026](/blog/how-many-new-flashcards-per-day/) and [How to Review Flashcards Faster in 2026](/blog/how-to-review-flashcards-faster/) are the next two articles I would open.
