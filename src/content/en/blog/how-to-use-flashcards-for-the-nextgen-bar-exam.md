---
title: "How to Use Flashcards for the NextGen Bar Exam in 2026: Rules, Issue Spotting, and Performance Tasks That Actually Stick"
description: "Taking the NextGen Bar Exam in 2026? Here is a practical flashcards workflow for black-letter rules, issue spotting, performance tasks, and FSRS without turning your deck into a second outline."
date: "2026-04-24"
keywords:
  - "NextGen Bar Exam flashcards"
  - "flashcards for the NextGen Bar Exam"
  - "NextGen UBE flashcards"
  - "bar exam flashcards 2026"
  - "issue spotting flashcards"
  - "performance task flashcards"
...
1. After a study block, capture only the rules, triggers, and repeat mistakes that look reusable.
2. Turn those into a small batch of candidate cards the same day or the next day.
3. Split them by function: `rules`, `issue-spotting`, `performance-tasks`, or `practice-misses`.
4. Delete anything that reads like outline residue instead of a retrieval prompt.
...
1. write narrower cards
2. separate rule cards from trigger cards and process cards
3. delete vague cards quickly
4. keep new-card volume realistic
5. let FSRS handle scheduling after the deck is worth scheduling
