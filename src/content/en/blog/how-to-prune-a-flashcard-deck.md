---
title: "How to Prune a Flashcard Deck in 2026: Delete, Suspend, or Rewrite Cards Before FSRS Buries You in Reviews"
description: "Too many flashcards and too many reviews usually mean your live deck needs triage, not more discipline. Here is a practical 2026 workflow for pruning a flashcard deck with delete, suspend, rewrite, leech cleanup, and FSRS review-load decisions."
date: "2026-07-01"
image: "/blog/how-to-prune-a-flashcard-deck.png"
keywords:
  - "how to prune a flashcard deck"
  - "too many flashcards"
  - "too many reviews anki"
  - "delete or suspend flashcards"
  - "leech cards anki"
  - "flashcard deck cleanup"
  - "fsrs desired retention"
  - "reduce flashcard review load"
---
...
This article is about the live-deck version of cleanup: deciding whether to delete, suspend, or rewrite cards that already made it into rotation. You are not filtering drafts. You are not digging out of a missed-week backlog. You are looking at a deck that technically works and realizing part of it should stop taking your time. If your problem starts earlier, while AI drafts are still entering the funnel, read [How to Avoid AI Flashcard Overload in 2026](/blog/how-to-avoid-ai-flashcard-overload/) first. If you are already staring at a missed-week disaster, [How to Catch Up on Flashcards After Falling Behind in 2026](/blog/how-to-catch-up-on-flashcards-after-falling-behind/) is the better guide.

![Warm desk scene with a hand sorting flashcards into keep, rewrite, suspend, and discard piles](/blog/how-to-prune-a-flashcard-deck.png)
...
If your reviews feel slow, this overlaps directly with [How to Review Flashcards Faster in 2026](/blog/how-to-review-flashcards-faster/). Fast review usually starts with clearer cards, not faster tapping.
...
If the deck is clean and the review load is still too high, then settings become a legitimate workload lever. [FSRS Settings in 2026](/blog/fsrs-settings/) goes deeper, but the short version is:
...
If you are setting that up from scratch, start with [Getting Started](/docs/getting-started/). If you want to inspect or run the project yourself later, the [self-hosting guide](/docs/self-hosting/) and [API docs](/docs/api/) are there.
