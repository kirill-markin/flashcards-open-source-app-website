---
title: "TOEFL Flashcards in 2026: Vocabulary, New iBT Task Types, and Practice-Test Misses"
description: "Build TOEFL flashcards for the new 2026 iBT: review vocabulary, sentence patterns, task types, and official-practice misses with FSRS—not outdated decks."
date: "2026-07-16"
image: "/blog/toefl-flashcards.png"
keywords:
  - "TOEFL flashcards"
  - "TOEFL iBT flashcards"
  - "flashcards for TOEFL"
  - "new TOEFL 2026"
  - "TOEFL vocabulary flashcards"
  - "TOEFL 2026 format"
  - "TOEFL practice test mistakes"
  - "spaced repetition TOEFL"
  - "FSRS TOEFL study"
---
...
![A warm TOEFL study desk where a checked official-practice mistake becomes one flashcard, surrounded by vocabulary, sentence-building, email, listening, and speaking cues.](/blog/toefl-flashcards.png)

## Use the TOEFL iBT format introduced on January 21, 2026

ETS introduced the updated TOEFL iBT worldwide [on January 21, 2026](https://www.ets.org/pdfs/toefl/toefl-ibt-updates-flyer-for-students.pdf). Its [current test-content page](https://www.ets.org/toefl/test-takers/ibt/about/content.html) lists the task types used in all four sections. The [2026 test blueprint](https://www.ets.org/content/dam/ets-org/pdfs/toefl/toefl-ibt-test-specifications-2026.pdf) says Reading and Listening follow a two-stage adaptive design: performance in the first module helps determine the second module. Writing and Speaking remain linear. ETS gives more context in its [transformation announcement](https://www.ets.org/newsroom/toefl-transformation-announcement.html).

Section and overall scores now use a 1–6 scale in half-point increments. ETS also provides a comparable estimate of the overall 0–120 score [through January 2028](https://www.ets.org/toefl/blog/understanding-toefl-ibt-score-displays.html). Check the current requirement for each institution instead of memorizing a conversion from an old prep book.
...
The task names and descriptions come from the current [ETS blueprint and specifications](https://www.ets.org/content/dam/ets-org/pdfs/toefl/toefl-ibt-test-specifications-2026.pdf). ETS also publishes a [teacher practice test](https://www.ets.org/content/dam/ets-org/pdfs/toefl/toefl-ibt-teachers-resources-practice-test-1.pdf) with examples of every task family. The PDF aligns with tests from January 21, 2026, but its directions and questions were adapted for paper. It is useful for learning the task shapes; it does not reproduce the live adaptive interface.
...
- Front: `allocate`
- Back: `to distribute for a purpose`

Meaning in context:

- Front: In `The university allocated additional rooms to first-year students`, what does `allocated` mean?
- Back: Assigned or distributed for a particular purpose.

Word form:

- Front: Use a form of `allocate` to complete the sentence, then name the word form: `The committee approved an ______ of funds to the library.`
- Back: `allocation` — a noun after `an` and before `of`.

Production:

- Front: Use the correct form of `allocate` to complete this sentence: `The department will ______ more funding to laboratory safety.`
- Back: `allocate`.
...
- Front: Reorder these chunks: `asked / whether / the deadline / Mia / had changed`
- Back: `Mia asked whether the deadline had changed.`

- Front: Correct the embedded question: `Could you tell me where is the advising office?`
- Back: `Could you tell me where the advising office is?`

- Front: Combine the ideas with a concession: `Online classes are flexible. Some students need more direct interaction.`
- Back: `Although online classes are flexible, some students need more direct interaction.`

- Front: Use `Could you confirm whether ...?` to ask politely and specifically if the workshop begins at 9:00 a.m.
...
Keep speaking frames loose. ETS advises against memorized answers in its guide to [common TOEFL iBT mistakes](https://www.ets.org/toefl/blog/common-toefl-ibt-mistakes-you-should-avoid.html). A short expansion cue can organize an answer. A stored monologue cannot train spontaneous speaking.
...
1. Choose material from the [current ETS preparation hub](https://www.ets.org/toefl/test-takers/ibt/prepare.html) and confirm that it covers the post–January 21, 2026 test.
2. Complete one task block under its stated conditions. Preserve the timing, and play each audio track only once, when the resource supports those conditions.
3. Record the task name, your answer, and the exact point of uncertainty.
4. Verify the result against the official answer key, scoring guidance, or task directions before drafting a card.
5. Classify the miss: vocabulary, sentence pattern, task decision, listening or speaking performance, writing, or timing.
6. Create a card only when a short retrieval target addresses the cause.
7. Retest the lesson with a different current official item.
...
[How to Turn Practice Questions Into Flashcards in 2026](/blog/how-to-turn-practice-questions-into-flashcards/) goes deeper into fact gaps, distinctions, sequences, and trap-pattern cards. [Flashcards vs Practice Tests in 2026](/blog/flashcards-vs-practice-tests/) explains why the card and the next fresh question should remain separate steps.
...
1. **Keep:** stable vocabulary, grammar, collocations, and general academic-language distinctions.
2. **Rewrite:** useful language trapped inside an old task shell. An old integrated-writing card about contrast language may still become a clean sentence-pattern card.
3. **Remove or archive:** task instructions, timing, scoring, and templates that describe only the pre–January 21, 2026 format.
...
If the deck is large, [How to Prune a Flashcard Deck in 2026](/blog/how-to-prune-a-flashcard-deck/) gives a practical deletion and rewriting workflow.
...
- one `TOEFL 2026` deck
- tags for section and current task type
- a source tag such as `ETS-practice-1`
- a miss tag such as `vocabulary`, `word-order`, `main-idea`, `tone`, or `omitted-requirement`
- review ratings based on what you actually retrieved

A 2025 [digital-flashcard experiment](https://pubmed.ncbi.nlm.nih.gov/41301342/) offers narrow support for the retrieval step. In a controlled session, 108 Chinese–English bilinguals learned 60 Swahili–Chinese word pairs. Retrieval practice with feedback produced better cued recall than restudying in tests given after a short interval. The authors say the condensed schedule limits conclusions about long-term learning. This study does not establish TOEFL score gains, transfer to full test tasks, or benefits over weeks of preparation.

FSRS schedules the cards you choose to keep. It cannot judge whether a source is current, a spoken answer is intelligible, or a full response meets the task. [How to Study for an Exam With FSRS in 2026](/blog/how-to-study-for-an-exam-with-fsrs/) explains how to keep review volume realistic before a fixed test date.
...
1. review due cards
2. complete current official practice
3. verify the misses
4. add a few narrow cards
5. rewrite or remove any card that was hard to grade
6. return to mixed, timed practice
...
1. Write a short miss log after current official practice.
2. Verify every correction against ETS material.
3. Add the log to AI chat, or attach it as a supported file, and ask for a few single-target front/back drafts.
4. Compare each draft with the verified correction and edit it yourself.
5. Review the cards you keep with FSRS. Rate the answer you produced, not how familiar the card looked.
...
The current product surface is documented on [Features](/features/) and [Getting Started](/docs/getting-started/).
