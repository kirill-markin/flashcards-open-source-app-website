---
title: "What Should Go on a Flashcard in 2026? A Practical Filter for Notes, AI Drafts, and Lecture Slides"
description: "Generating flashcards is easy in 2026. Deciding what actually deserves a card is the hard part. Here is a practical filter for notes, AI drafts, lecture slides, and textbook pages so you keep the cards worth reviewing with FSRS and skip the rest."
image: "/blog/what-should-go-on-a-flashcard.png"
date: "2026-06-16"
keywords:
  - "what should go on a flashcard"
  - "how to decide what goes on a flashcard"
  - "what belongs on a flashcard"
  - "card-worthy notes"
  - "AI flashcards too many cards"
  - "making flashcards from every sentence"
  - "how to filter flashcards"
  - "which notes deserve flashcards"
  - "good flashcard selection"
---
...
![Warm desk scene with draft flashcards being filtered into a small review-worthy stack](/blog/what-should-go-on-a-flashcard.png)
...
[How to Turn Practice Questions Into Flashcards in 2026](/blog/how-to-turn-practice-questions-into-flashcards/) works well for exactly this reason. Missed questions already tell you where the friction is.
...
- Front: What changes quantity demanded without shifting the demand curve?
  Back: A change in the good's own price.
- Front: Which stage comes after metaphase in mitosis?
  Back: Anaphase.
...
If the idea is worth keeping, tighten it. [How to Make Better Flashcards in 2026](/blog/how-to-make-better-flashcards/) goes deeper on that part.
...
[When to Make Flashcards in 2026](/blog/when-to-make-flashcards/) covers the timing question in more detail, but the short version holds up: understand the chunk first, then card the parts that still feel slippery.
...
If the batch already exists and needs cleanup, [How to Avoid AI Flashcard Overload in 2026](/blog/how-to-avoid-ai-flashcard-overload/) and [How to Fix AI Flashcards in 2026](/blog/how-to-fix-ai-flashcards/) cover the repair work. This article is the filter that comes before that.
...
If lecture material is your starting point, [How to Turn Lecture Recordings Into Flashcards in 2026](/blog/how-to-turn-lecture-recordings-into-flashcards/) helps upstream. The selection step still matters after the draft.
...
That matches the public product surface today: card creation, AI chat with file attachments, deck organization, and scheduled review. If you are setting that up for the first time, [Getting Started](/docs/getting-started/) is the shortest path.
