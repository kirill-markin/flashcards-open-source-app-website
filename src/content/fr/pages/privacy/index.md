...
Par ailleurs, les liens d'installation du catalogue envoient un événement de clic à notre propre collecteur d'analyse produit, avec l'identifiant de version du paquet public, la langue d'interface de la page, la langue de l'appareil du navigateur, l'emplacement du lien, la catégorie de source, la catégorie d'appareil et l'identifiant `analytics_visitor` décrit ci-dessous lorsque votre navigateur en porte un. Ce collecteur ne déduit pas le pays à partir du clic. Lorsque le navigateur expose Global Privacy Control ou Do Not Track, le site n'envoie aucun événement de clic à ce collecteur, ne demande aucun identifiant de visiteur et n'affiche pas le bandeau de consentement.
