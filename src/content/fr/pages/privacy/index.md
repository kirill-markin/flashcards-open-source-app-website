...
Par ailleurs, le site envoie des événements à notre propre collecteur d'analyse produit : un événement de consultation de page pour chaque page que vous ouvrez, et un événement de clic lorsque vous suivez un lien vers l'application web, une boutique d'applications ou l'installation d'un paquet du catalogue. Selon l'événement, ils comportent le type de page, l'identifiant de version du paquet public sur les pages de paquets du catalogue et dans les liens d'installation, l'emplacement du lien, la langue d'interface de la page, la langue de l'appareil du navigateur, la catégorie de source, la catégorie d'appareil et l'identifiant `analytics_visitor` décrit ci-dessous lorsque votre navigateur en porte un. Ce collecteur ne déduit pas le pays à partir de ces événements. Lorsque le navigateur expose Global Privacy Control ou Do Not Track, le site n'envoie aucun événement à ce collecteur, ne demande aucun identifiant de visiteur et n'affiche pas le bandeau de consentement.
