...
4. नेटवर्क लौटते ही सिंक उन्हें भेज दे और दूरस्थ बदलाव वापस ले आए
...
[Flashcards](https://flashcards-open-source-app.com/) यहाँ दिलचस्प इसलिए है, क्योंकि यह उत्पाद पहले से उसी रूप में बना हुआ है जैसा मैं वास्तव में चाहता हूँ।
...
- [सिस्टम की बनावट से जुड़े दस्तावेज़](https://flashcards-open-source-app.com/docs/architecture/)
- [अपना सर्वर चलाने की मार्गदर्शिका](https://flashcards-open-source-app.com/docs/self-hosting/)
...
- [Flashcards वेबसाइट खोलें](https://flashcards-open-source-app.com/)
- [ऐप खोलकर देखें](https://app.flashcards-open-source-app.com/)
- [सिस्टम की बनावट से जुड़े दस्तावेज़ पढ़ें](https://flashcards-open-source-app.com/docs/architecture/)
