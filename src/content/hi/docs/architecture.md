...
4. एजेंट `/v1/agent/me` लोड करता है, workspaces की सूची पढ़ता है, ज़रूरत पड़ने पर एक चुनता है, और फिर `/v1/agent/sql/query` और `/v1/agent/sql/execute` का उपयोग करता है।
