...
description: Nibomo को PostgreSQL, ऑथ, बैकएंड, वेब और एडमिन के साथ लोकल रूप से चलाएँ या दस्तावेज़ित AWS CDK प्रोडक्शन स्टैक डिप्लॉय करें।
---

Nibomo दो अलग रास्तों का समर्थन करता है: लोकल डेवलपमेंट एनवायरनमेंट और AWS पर प्रोडक्शन डिप्लॉयमेंट। Docker Compose लोकल डेवलपमेंट के लिए PostgreSQL और माइग्रेशन चलाता है; यह प्रोडक्शन डिप्लॉयमेंट का तरीका नहीं है।
