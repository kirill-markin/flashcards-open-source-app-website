...
- `list_workspaces` — उन workspaces की सख्ती से केवल पढ़ने वाली सूची जिन तक आपकी
  ...
  गतिविधि, और क्या वह आपका वर्तमान में चुना हुआ डिफ़ॉल्ट है। `sql_query` और
  `sql_execute` के `workspaceId` आर्गुमेंट के लिए वापस मिले `workspaceId` का
  उपयोग करें।
...
- **पढ़ने/लिखने का विभाजन**: `sql_query` और `list_workspaces` सख्ती से केवल
  पढ़ने के लिए हैं (`readOnlyHint`) और डेटा की मरम्मत, scheduling की पुनर्गणना,
  या कार्ड state में बदलाव कभी नहीं करते। `sql_execute` एकमात्र write tool है
  और लिखने का कार्य करता है (`destructiveHint`)।
