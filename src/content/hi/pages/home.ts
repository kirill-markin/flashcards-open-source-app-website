...
export const HOME_PAGE_CONTENT: PageContent = {
  title: "Nibomo - मुफ़्त और ओपन-सोर्स स्पेस्ड रिपिटीशन ऐप",
  description:
  ...
  sections: [
    {
      ...
      subtitle:
        "एक मुफ़्त, ओपन-सोर्स फ्लैशकार्ड ऐप, जो हर दोहराव का सही समय तय करता है, ऑफ़लाइन चलता है और वेब, iOS व Android पर सिंक रहता है। फ्लैशकार्ड बनाने या बेहतर करने में मदद चाहिए, तो AI का इस्तेमाल करें। Nibomo को पहले Flashcards Open Source App कहा जाता था।",
      trustLine:
