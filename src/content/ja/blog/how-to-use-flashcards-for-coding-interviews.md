...
自分のミスログを作る前にすぐ使える出発点が欲しいなら、[Python 解答付き Blind 75 デッキ](/catalog/packages/blind-75-python-solutions/)では、定番75問をそれぞれ、中心となるデータ構造、アルゴリズム、計算量、エッジケース、Pythonによる解答を扱うカードにしています。
