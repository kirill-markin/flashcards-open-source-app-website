...
> **情報開示：** 私はKirill Markinです。以下で比較する代替アプリ、[Nibomo](https://flashcards-open-source-app.com/)を開発しています。公式資料を見る限り、Gizmoの学習フローは、対応する資料形式、5種類のカード、AI Tutorのレッスン、多様なクイズ、ゲーム感覚の進行システムなど、より幅広いものです。Nibomoは意図的に機能を絞っています。
