...
こうした学習方法にはAnkiがよく合っています。TXTによる移行はAnkiそのものへの評価ではありません。価値の中心がノートの内容にある人向けの、用途を絞った手段です。[AnkiとNibomoの詳しい比較](/ja/blog/anki-vs-flashcards-open-source-app/)では、誰もが乗り換えるべきだとは決めつけずに、両製品のトレードオフを説明しています。
