...
この流れに合うのが、[機能ページ](/features/) と [導入ガイド](/docs/getting-started/) です。表裏カードと FSRS 復習を1つの場所で回したいなら相性がいいです。Nibomo は、ここではあくまで学習ツールであり、NREMT の公式製品ではありません。
...
このワークフローを支えるツールを探しているなら、[導入ガイド](/docs/getting-started/) から始めるか、[機能ページ](/features/) を見るとよいです。Nibomo は FSRS 復習を中心にしたオープンソースの学習ツールです。NREMT とは提携しておらず、巨大な要約ではなく、実際の失点から作った小さなカードを入れたときに最もよく機能します。
