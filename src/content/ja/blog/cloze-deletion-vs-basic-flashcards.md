...
[Nibomoの機能](/ja/features/) では、表面と裏面を明示するカード形式を採用しています。このアプリには、ネイティブな cloze 構文、cloze 表示、cloze ノートの自動生成機能はありません。穴埋め素材から始める場合は、上の例のように、覚えたい内容を表面の質問と裏面の答えに変換してください。
