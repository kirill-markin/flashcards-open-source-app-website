...
この記事は、公式または既製のN10-009デッキを提供するものではありません。現行のCompTIA試験範囲と、正規の教材や演習で自分が実際に間違えた箇所を基にカードを作ってください。Nibomoでデッキを作る場合は、[スタートガイド](/ja/docs/getting-started/)でホスト版とセルフホスト版の始め方を確認できます。
