...
> **開示事項:** 私はKirill Markinです。[Nibomo](/ja/features/)を開発しています。このガイドは、表面・裏面式のどのフラッシュカードアプリでも実践できます。Nibomoについて触れるのは、実際のワークフローに関係する箇所だけです。だからといって、すべての学習者が使うべきだと主張するものではありません。
