...
フルスタックのソースと、運用者が管理できるバックエンドこそが乗り換えの理由であり、カードを安全に作り直せるほど単純な場合にNibomoを選びましょう。まず小さな一時デッキを試すなら、[ホスト版アプリを開いてください](https://app.nibomo.com/)。学習状態を正確に引き継ぐことが最優先なら、Ankiを使い続けるか、RemNote、Mochi、Mnemosyneをテストするほうが適切です。
