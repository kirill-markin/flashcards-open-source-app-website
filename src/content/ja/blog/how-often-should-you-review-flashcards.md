...
復習日はFSRSに任せ、想起は自分で行います。紙のカレンダーを管理せずにこのスケジュールを使いたいなら、[Nibomoの機能](/features/)と[使い始めガイド](/docs/getting-started/)をご覧ください。効果的な習慣は複雑ではありません。開く、思い出す、評価する、閉じる。そして明日また戻る。それだけです。
