...
私はFlashcardsを開発していますが、StudySmarter全体の代わりとしては勧めません。カードだけに絞った環境が欲しいから **StudySmarterの代替** を探している人には勧めます。当てはまるなら、[Nibomoの機能](/features/)を確認するか、[使い始めガイド](/docs/getting-started/)から始めてください。
