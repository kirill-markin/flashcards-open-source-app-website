...
具体的に範囲を絞った例なら、[単位円フラッシュカード：16の角度・ラジアン・正確な座標](/catalog/packages/unit-circle-degrees-radians-coordinates/)で、単位円上の16個の標準位置を度数法、ラジアン、正確な座標の対応で練習できます。テーマ全体を情報過多の1枚に詰め込む必要はありません。
