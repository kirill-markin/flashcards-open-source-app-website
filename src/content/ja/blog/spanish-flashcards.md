...
[Nibomo](/ja/features/)は、この学習法のうち復習の部分を担います。表面・裏面カード、デッキとタグ、FSRSによる復習期限の管理、AIを使ったカード作成支援、オフライン学習、Web・iOS・Android間の同期、データを移行できるインポートとエクスポート、オープンソースでのセルフホスティングに対応しています。
