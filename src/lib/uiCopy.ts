...
interface AppUiCopy {
  ...
  readonly home: {
    readonly activity: {
      ...
      readonly earlierDatesLabel: string;
      readonly laterDatesLabel: string;
      readonly latestDatesLabel: string;
  ...
  en: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Completed UTC days (inclusive)",
        daysInRangeLabel: "Days in range",
        description:
          "See aggregate daily review activity across all channels. Published figures are aggregate counts and do not expose card content, email addresses, or individual study histories.",
        earlierDatesLabel: "Earlier dates",
        laterDatesLabel: "Later dates",
        latestDatesLabel: "Latest dates",
        eyebrow: "Activity",
        lastUpdatedLabel: "Snapshot generated",
  ...
  es: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Días completos en UTC (inclusive)",
        daysInRangeLabel: "Días en el rango",
        description:
          "Consulta la actividad diaria agregada de repasos de todos los canales. Las cifras publicadas son recuentos agregados y no exponen el contenido de las tarjetas, las direcciones de correo electrónico ni los historiales de estudio individuales.",
        earlierDatesLabel: "Fechas anteriores",
        laterDatesLabel: "Fechas posteriores",
        latestDatesLabel: "Fechas más recientes",
        eyebrow: "Actividad",
        lastUpdatedLabel: "Datos generados",
  ...
  ar: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "أيام مكتملة بتوقيت UTC (شاملة)",
        daysInRangeLabel: "الأيام في النطاق",
        description:
          "اطّلع على نشاط المراجعة اليومي الإجمالي عبر جميع القنوات. الأرقام المنشورة هي أعداد إجمالية ولا تكشف محتوى البطاقات أو عناوين البريد الإلكتروني أو سجلات الدراسة الفردية.",
        earlierDatesLabel: "تواريخ أقدم",
        laterDatesLabel: "تواريخ أحدث",
        latestDatesLabel: "أحدث التواريخ",
        eyebrow: "النشاط",
        lastUpdatedLabel: "وقت إنشاء البيانات",
  ...
  de: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Vollständige UTC-Tage (einschließlich)",
        daysInRangeLabel: "Tage im Zeitraum",
        description:
          "Sieh dir die gesamte tägliche Wiederholungsaktivität über alle Kanäle an. Die veröffentlichten Zahlen sind aggregierte Zählwerte und legen weder Karteninhalte noch E-Mail-Adressen oder individuelle Lernverläufe offen.",
        earlierDatesLabel: "Frühere Daten",
        laterDatesLabel: "Spätere Daten",
        latestDatesLabel: "Neueste Daten",
        eyebrow: "Aktivität",
        lastUpdatedLabel: "Datenstand erstellt",
  ...
  hi: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "पूरे UTC दिन (दोनों तारीख़ें शामिल)",
        daysInRangeLabel: "सीमा में दिन",
        description:
          "सभी माध्यमों पर रोज़ की कुल रिव्यू गतिविधि देखें। प्रकाशित आंकड़े केवल कुल गिनती हैं; इनमें कार्ड का कॉन्टेंट, ईमेल पते या किसी व्यक्ति का पढ़ाई का इतिहास शामिल नहीं है।",
        earlierDatesLabel: "पहले की तारीख़ें",
        laterDatesLabel: "बाद की तारीख़ें",
        latestDatesLabel: "नवीनतम तारीख़ें",
        eyebrow: "गतिविधि",
        lastUpdatedLabel: "डेटा तैयार किया गया",
  ...
  ja: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "完了したUTC日（両端を含む）",
        daysInRangeLabel: "期間内の日数",
        description:
          "すべての経路からの日別レビュー活動を集計値で確認できます。 公開される数値は集計データであり、カードの内容、メールアドレス、個人の学習履歴は公開されません。",
        earlierDatesLabel: "過去の日付",
        laterDatesLabel: "先の日付",
        latestDatesLabel: "最新の日付",
        eyebrow: "アクティビティ",
        lastUpdatedLabel: "データ生成日時",
  ...
  fr: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Jours UTC complets (bornes incluses)",
        daysInRangeLabel: "Jours dans la période",
        description:
          "Consultez l'activité de révision quotidienne agrégée de tous les canaux. Les chiffres publiés sont des totaux agrégés et ne révèlent ni le contenu des cartes, ni les adresses e-mail, ni les historiques d'étude individuels.",
        earlierDatesLabel: "Dates précédentes",
        laterDatesLabel: "Dates suivantes",
        latestDatesLabel: "Dates les plus récentes",
        eyebrow: "Activité",
        lastUpdatedLabel: "Données générées",
  ...
  pt: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Dias completos em UTC (inclusive)",
        daysInRangeLabel: "Dias no período",
        description:
          "Veja a atividade diária agregada de revisões de todos os canais. Os números publicados são contagens agregadas e não expõem o conteúdo dos cartões, endereços de e-mail nem históricos de estudo individuais.",
        earlierDatesLabel: "Datas anteriores",
        laterDatesLabel: "Datas seguintes",
        latestDatesLabel: "Datas mais recentes",
        eyebrow: "Atividade",
        lastUpdatedLabel: "Dados gerados",
  ...
  ru: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Полные дни UTC (включительно)",
        daysInRangeLabel: "Дней в периоде",
        description:
          "Посмотрите суммарную дневную активность повторений по всем каналам. Публикуются только суммарные показатели: они не раскрывают содержимое карточек, адреса электронной почты и индивидуальную историю обучения.",
        earlierDatesLabel: "Предыдущие даты",
        laterDatesLabel: "Следующие даты",
        latestDatesLabel: "Последние даты",
        eyebrow: "Активность",
        lastUpdatedLabel: "Данные сформированы",
        ...
        platformLabels: {
          agent: "Агент",
          unattributed: "Источник неизвестен",
          android: "Android",
          ios: "iOS",
          web: "Веб",
        },
  ...
  zh: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "完整的UTC日期（含首尾两日）",
        daysInRangeLabel: "范围内天数",
        description:
          "查看所有渠道汇总的每日复习活动。 发布的数字均为汇总计数，不会公开卡片内容、电子邮件地址或个人学习记录。",
        earlierDatesLabel: "较早日期",
        laterDatesLabel: "较晚日期",
        latestDatesLabel: "最新日期",
        eyebrow: "活动",
        lastUpdatedLabel: "数据生成时间",
  ...
  it: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Giorni UTC completi (estremi inclusi)",
        daysInRangeLabel: "Giorni nell'intervallo",
        description:
          "Guarda l'attività di ripasso giornaliera aggregata di tutti i canali. Le cifre pubblicate sono conteggi aggregati e non rivelano il contenuto delle carte, gli indirizzi email o lo storico di studio delle singole persone.",
        earlierDatesLabel: "Date precedenti",
        laterDatesLabel: "Date successive",
        latestDatesLabel: "Date più recenti",
        eyebrow: "Attività",
        lastUpdatedLabel: "Dati generati",
  ...
  ko: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "완료된 UTC 날짜 (시작일·종료일 포함)",
        daysInRangeLabel: "기간 내 일수",
        description:
          "모든 경로의 일별 복습 활동을 집계해서 볼 수 있습니다. 공개되는 수치는 집계값이며 카드 내용, 이메일 주소, 개인 학습 기록은 드러나지 않습니다.",
        earlierDatesLabel: "이전 날짜",
        laterDatesLabel: "이후 날짜",
        latestDatesLabel: "최근 날짜",
        eyebrow: "활동",
        lastUpdatedLabel: "데이터 생성 시각",
  ...
  id: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Hari UTC lengkap (inklusif)",
        daysInRangeLabel: "Hari dalam rentang",
        description:
          "Lihat aktivitas tinjauan harian gabungan dari semua saluran. Angka yang dipublikasikan adalah jumlah gabungan dan tidak menampilkan isi kartu, alamat email, atau riwayat belajar perorangan.",
        earlierDatesLabel: "Tanggal sebelumnya",
        laterDatesLabel: "Tanggal berikutnya",
        latestDatesLabel: "Tanggal terbaru",
        eyebrow: "Aktivitas",
        lastUpdatedLabel: "Data dibuat",
  ...
  tr: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Tamamlanmış UTC günleri (dahil)",
        daysInRangeLabel: "Aralıktaki gün sayısı",
        description:
          "Tüm kanallardaki toplam günlük tekrar etkinliğini görün. Yayımlanan rakamlar toplu sayımlardır; kart içeriğini, e-posta adreslerini veya kişisel çalışma geçmişlerini açığa çıkarmaz.",
        earlierDatesLabel: "Önceki tarihler",
        laterDatesLabel: "Sonraki tarihler",
        latestDatesLabel: "En son tarihler",
        eyebrow: "Etkinlik",
        lastUpdatedLabel: "Veri oluşturulma zamanı",
  ...
  nl: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Volledige UTC-dagen (inclusief)",
        daysInRangeLabel: "Dagen in periode",
        description:
          "Bekijk de totale dagelijkse herhaalactiviteit van alle kanalen. De gepubliceerde cijfers zijn totalen en tonen geen kaartinhoud, e-mailadressen of individuele leergeschiedenis.",
        earlierDatesLabel: "Eerdere datums",
        laterDatesLabel: "Latere datums",
        latestDatesLabel: "Nieuwste datums",
        eyebrow: "Activiteit",
        lastUpdatedLabel: "Gegevens gegenereerd",
  ...
  pl: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Pełne dni UTC (włącznie)",
        daysInRangeLabel: "Dni w zakresie",
        description:
          "Zobacz zbiorczą dzienną aktywność powtórek ze wszystkich kanałów. Publikowane liczby są danymi zbiorczymi i nie ujawniają treści kart, adresów e-mail ani indywidualnej historii nauki.",
        earlierDatesLabel: "Wcześniejsze daty",
        laterDatesLabel: "Późniejsze daty",
        latestDatesLabel: "Najnowsze daty",
        eyebrow: "Aktywność",
        lastUpdatedLabel: "Dane wygenerowano",
  ...
  vi: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Ngày UTC đã hoàn tất (gồm cả hai đầu)",
        daysInRangeLabel: "Số ngày trong khoảng",
        description:
          "Xem hoạt động ôn tập tổng hợp theo ngày từ mọi kênh. Các số liệu công bố đều là số liệu tổng hợp và không tiết lộ nội dung thẻ, địa chỉ email hay lịch sử học của từng người.",
        earlierDatesLabel: "Ngày trước",
        laterDatesLabel: "Ngày sau",
        latestDatesLabel: "Ngày mới nhất",
        eyebrow: "Hoạt động",
        lastUpdatedLabel: "Dữ liệu được tạo",
        ...
        platformLabels: {
          agent: "Tác nhân",
          unattributed: "Chưa xác định nguồn",
          android: "Android",
          ios: "iOS",
          web: "Web",
        },
  ...
  th: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "วันที่สิ้นสุดแล้วตาม UTC (รวมวันแรกและวันสุดท้าย)",
        daysInRangeLabel: "จำนวนวันในช่วง",
        description:
          "ดูภาพรวมกิจกรรมการทบทวนรายวันจากทุกช่องทาง ตัวเลขที่เผยแพร่เป็นยอดรวม ไม่เปิดเผยเนื้อหาการ์ด อีเมล หรือประวัติการเรียนของแต่ละคน",
        earlierDatesLabel: "วันก่อนหน้า",
        laterDatesLabel: "วันถัดไป",
        latestDatesLabel: "วันล่าสุด",
        eyebrow: "กิจกรรม",
        lastUpdatedLabel: "เวลาสร้างข้อมูล",
        ...
        platformLabels: {
          agent: "เอเจนต์",
          unattributed: "ไม่ทราบแหล่งที่มา",
          android: "Android",
          ios: "iOS",
          web: "เว็บ",
        },
  ...
  uk: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Повні дні UTC (включно)",
        daysInRangeLabel: "Днів у періоді",
        description:
          "Перегляньте сукупну щоденну активність повторень за всіма каналами. Публікуються лише загальні підрахунки: вони не розкривають вміст карток, електронні адреси та індивідуальну історію навчання.",
        earlierDatesLabel: "Попередні дати",
        laterDatesLabel: "Наступні дати",
        latestDatesLabel: "Останні дати",
        eyebrow: "Активність",
        lastUpdatedLabel: "Дані сформовано",
  ...
  he: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "ימי UTC שהסתיימו (כולל שני הקצוות)",
        daysInRangeLabel: "ימים בטווח",
        description:
          "ראה את פעילות החזרות היומית המצטברת מכל הערוצים. המספרים המפורסמים הם נתונים מצטברים ואינם חושפים תוכן של כרטיסים, כתובות אימייל או היסטוריית לימוד אישית.",
        earlierDatesLabel: "תאריכים מוקדמים",
        laterDatesLabel: "תאריכים מאוחרים",
        latestDatesLabel: "התאריכים האחרונים",
        eyebrow: "פעילות",
        lastUpdatedLabel: "מועד יצירת הנתונים",
  ...
  sv: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Avslutade UTC-dagar (inklusive)",
        daysInRangeLabel: "Dagar i intervallet",
        description:
          "Se sammanlagd daglig repetitionsaktivitet från alla kanaler. Publicerade siffror är sammanlagda antal och visar inte kortinnehåll, e-postadresser eller enskilda plugghistoriker.",
        earlierDatesLabel: "Tidigare datum",
        laterDatesLabel: "Senare datum",
        latestDatesLabel: "Senaste datum",
        eyebrow: "Aktivitet",
        lastUpdatedLabel: "Data skapades",
  ...
  da: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Afsluttede UTC-dage (inklusive)",
        daysInRangeLabel: "Dage i perioden",
        description:
          "Se den samlede daglige repetitionsaktivitet fra alle kanaler. De offentliggjorte tal er samlede antal og afslører hverken kortenes indhold, e-mailadresser eller den enkeltes læringshistorik.",
        earlierDatesLabel: "Tidligere datoer",
        laterDatesLabel: "Senere datoer",
        latestDatesLabel: "Seneste datoer",
        eyebrow: "Aktivitet",
        lastUpdatedLabel: "Data genereret",
  ...
  nb: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Fullførte UTC-dager (inklusive)",
        daysInRangeLabel: "Dager i perioden",
        description:
          "Se samlet daglig repetisjonsaktivitet fra alle kanaler. Publiserte tall er aggregerte antall og avslører ikke kortinnhold, e-postadresser eller studiehistorikken til enkeltpersoner.",
        earlierDatesLabel: "Tidligere datoer",
        laterDatesLabel: "Senere datoer",
        latestDatesLabel: "Nyeste datoer",
        eyebrow: "Aktivitet",
        lastUpdatedLabel: "Data generert",
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Päättyneet UTC-päivät (rajapäivät mukana)",
        daysInRangeLabel: "Päiviä aikavälillä",
        description:
          "Katso päivittäistä kertausaktiivisuutta kaikista kanavista. Julkaistut luvut ovat koostelukuja eivätkä paljasta korttien sisältöä, sähköpostiosoitteita tai yksittäisiä opiskeluhistorioita.",
        earlierDatesLabel: "Aiemmat päivät",
        laterDatesLabel: "Myöhemmät päivät",
        latestDatesLabel: "Uusimmat päivät",
        eyebrow: "Aktiivisuus",
        lastUpdatedLabel: "Tiedot luotu",
  ...
  cs: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Dokončené dny UTC (včetně)",
        daysInRangeLabel: "Počet dní v období",
        description:
          "Podívejte se na souhrnnou denní aktivitu opakování ze všech kanálů. Zveřejněné údaje jsou souhrnné počty a neodhalují obsah kartiček, e-mailové adresy ani historii učení jednotlivců.",
        earlierDatesLabel: "Dřívější data",
        laterDatesLabel: "Pozdější data",
        latestDatesLabel: "Nejnovější data",
        eyebrow: "Aktivita",
        lastUpdatedLabel: "Data vytvořena",
  ...
  el: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Ολοκληρωμένες ημέρες UTC (συμπεριλαμβάνονται τα άκρα)",
        daysInRangeLabel: "Ημέρες στο εύρος",
        description:
          "Δείτε τη συνολική καθημερινή δραστηριότητα επανάληψης από όλα τα κανάλια. Τα δημοσιευμένα νούμερα είναι συγκεντρωτικά και δεν αποκαλύπτουν περιεχόμενο καρτών, διευθύνσεις email ή ιστορικό μελέτης μεμονωμένων ατόμων.",
        earlierDatesLabel: "Προηγούμενες ημερομηνίες",
        laterDatesLabel: "Επόμενες ημερομηνίες",
        latestDatesLabel: "Πιο πρόσφατες ημερομηνίες",
        eyebrow: "Δραστηριότητα",
        lastUpdatedLabel: "Δημιουργία δεδομένων",
  ...
  ro: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Zile UTC încheiate (inclusiv)",
        daysInRangeLabel: "Zile în interval",
        description:
          "Vezi activitatea zilnică agregată de recapitulare din toate canalele. Cifrele publicate sunt totaluri agregate și nu expun conținutul fișelor, adresele de e-mail sau istoricul de studiu al fiecărei persoane.",
        earlierDatesLabel: "Date anterioare",
        laterDatesLabel: "Date ulterioare",
        latestDatesLabel: "Cele mai recente date",
        eyebrow: "Activitate",
        lastUpdatedLabel: "Date generate",
  ...
  hu: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Lezárt UTC-napok (határnapokkal együtt)",
        daysInRangeLabel: "Napok az időszakban",
        description:
          "Nézd meg az összes csatorna összesített napi ismétlési aktivitását. A közölt számok összesítések, és nem fedik fel a kártyák tartalmát, az e-mail-címeket vagy az egyéni tanulási előzményeket.",
        earlierDatesLabel: "Korábbi dátumok",
        laterDatesLabel: "Későbbi dátumok",
        latestDatesLabel: "Legutóbbi dátumok",
        eyebrow: "Aktivitás",
        lastUpdatedLabel: "Adatok létrehozva",
  ...
  fa: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "روزهای کامل UTC (شامل دو سر بازه)",
        daysInRangeLabel: "روزهای بازه",
        description:
          "فعالیت روزانهٔ مرور را به‌صورت تجمیعی در همهٔ کانال‌ها ببینید. ارقام منتشرشده شمارش‌های تجمیعی هستند و محتوای کارت‌ها، نشانی‌های ایمیل یا تاریخچهٔ مطالعهٔ افراد را فاش نمی‌کنند.",
        earlierDatesLabel: "تاریخ‌های قبلی",
        laterDatesLabel: "تاریخ‌های بعدی",
        latestDatesLabel: "جدیدترین تاریخ‌ها",
        eyebrow: "فعالیت",
        lastUpdatedLabel: "زمان تولید داده‌ها",
  ...
  ca: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Dies UTC complets (inclosos els extrems)",
        daysInRangeLabel: "Dies de l'interval",
        description:
          "Consulta l'activitat diària agregada de repàs de tots els canals. Les xifres publicades són recomptes agregats i no revelen el contingut de les targetes, les adreces de correu electrònic ni els historials d'estudi individuals.",
        earlierDatesLabel: "Dates anteriors",
        laterDatesLabel: "Dates posteriors",
        latestDatesLabel: "Dates més recents",
        eyebrow: "Activitat",
        lastUpdatedLabel: "Dades generades",
  ...
  bn: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "সম্পূর্ণ UTC দিন (উভয় তারিখসহ)",
        daysInRangeLabel: "পরিসরের দিন",
        description:
          "সব মাধ্যমের দৈনিক মোট রিভিউ কার্যকলাপ দেখুন। প্রকাশিত সংখ্যাগুলো কেবল সমষ্টিগত গণনা; এতে কার্ডের বিষয়বস্তু, ইমেইল ঠিকানা বা কারও ব্যক্তিগত পড়ার ইতিহাস থাকে না।",
        earlierDatesLabel: "আগের তারিখ",
        laterDatesLabel: "পরের তারিখ",
        latestDatesLabel: "সর্বশেষ তারিখ",
        eyebrow: "কার্যক্রম",
        lastUpdatedLabel: "ডেটা তৈরির সময়",
  ...
  gu: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "પૂર્ણ થયેલા UTC દિવસો (બંને તારીખો સહિત)",
        daysInRangeLabel: "શ્રેણીના દિવસો",
        description:
          "બધા માધ્યમોની દૈનિક કુલ રિવ્યૂ પ્રવૃત્તિ જુઓ. પ્રકાશિત આંકડા માત્ર કુલ ગણતરી છે; તેમાં કાર્ડની સામગ્રી, ઈમેલ સરનામાં કે કોઈ વ્યક્તિનો અભ્યાસ ઇતિહાસ હોતો નથી.",
        earlierDatesLabel: "અગાઉની તારીખો",
        laterDatesLabel: "પછીની તારીખો",
        latestDatesLabel: "તાજેતરની તારીખો",
        eyebrow: "પ્રવૃત્તિ",
        lastUpdatedLabel: "ડેટા બનાવ્યાનો સમય",
  ...
  kn: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "ಪೂರ್ಣಗೊಂಡ UTC ದಿನಗಳು (ಎರಡೂ ದಿನಾಂಕಗಳು ಸೇರಿ)",
        daysInRangeLabel: "ವ್ಯಾಪ್ತಿಯ ದಿನಗಳು",
        description:
          "ಎಲ್ಲ ಮಾಧ್ಯಮಗಳ ದೈನಂದಿನ ಒಟ್ಟು ಮರುಅಭ್ಯಾಸ ಚಟುವಟಿಕೆಯನ್ನು ನೋಡಿ. ಪ್ರಕಟಿತ ಅಂಕಿಗಳು ಒಟ್ಟು ಎಣಿಕೆಗಳಷ್ಟೇ; ಅವು ಕಾರ್ಡ್ ವಿಷಯ, ಇಮೇಲ್ ವಿಳಾಸ ಅಥವಾ ವ್ಯಕ್ತಿಗತ ಅಧ್ಯಯನ ಇತಿಹಾಸವನ್ನು ಬಹಿರಂಗಪಡಿಸುವುದಿಲ್ಲ.",
        earlierDatesLabel: "ಹಿಂದಿನ ದಿನಾಂಕಗಳು",
        laterDatesLabel: "ಮುಂದಿನ ದಿನಾಂಕಗಳು",
        latestDatesLabel: "ಇತ್ತೀಚಿನ ದಿನಾಂಕಗಳು",
        eyebrow: "ಚಟುವಟಿಕೆ",
        lastUpdatedLabel: "ಡೇಟಾ ರಚಿಸಿದ ಸಮಯ",
  ...
  ml: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "പൂർത്തിയായ UTC ദിവസങ്ങൾ (ഇരുവശത്തെ തീയതികളും ഉൾപ്പെടെ)",
        daysInRangeLabel: "പരിധിയിലെ ദിവസങ്ങൾ",
        description:
          "എല്ലാ മാർഗങ്ങളിൽ നിന്നുമുള്ള ദിവസേനയുള്ള ആകെ ആവർത്തന പ്രവർത്തനം കാണുക. പ്രസിദ്ധീകരിച്ച കണക്കുകൾ ആകെത്തുകകൾ മാത്രമാണ്; അവ കാർഡ് ഉള്ളടക്കമോ ഇമെയിൽ വിലാസങ്ങളോ വ്യക്തിഗത പഠന ചരിത്രമോ വെളിപ്പെടുത്തുന്നില്ല.",
        earlierDatesLabel: "മുമ്പത്തെ തീയതികൾ",
        laterDatesLabel: "പിന്നീടുള്ള തീയതികൾ",
        latestDatesLabel: "ഏറ്റവും പുതിയ തീയതികൾ",
        eyebrow: "പ്രവർത്തനം",
        lastUpdatedLabel: "ഡാറ്റ സൃഷ്ടിച്ച സമയം",
        ...
        platformLabels: {
          agent: "ഏജന്റ്",
          unattributed: "ഉറവിടം വ്യക്തമല്ല",
          android: "Android",
          ios: "iOS",
          web: "വെബ്",
        },
  ...
  mr: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "पूर्ण झालेले UTC दिवस (दोन्ही तारखांसह)",
        daysInRangeLabel: "श्रेणीतील दिवस",
        description:
          "सर्व माध्यमांवरील रोजची एकत्रित उजळणी क्रिया पाहा. प्रकाशित आकडे केवळ एकत्रित मोजणी आहेत; त्यात कार्डाचा मजकूर, ईमेल पत्ते किंवा कोणाचाही वैयक्तिक अभ्यास इतिहास उघड होत नाही.",
        earlierDatesLabel: "आधीच्या तारखा",
        laterDatesLabel: "पुढच्या तारखा",
        latestDatesLabel: "सर्वात अलीकडील तारखा",
        eyebrow: "क्रिया",
        lastUpdatedLabel: "डेटा तयार केल्याची वेळ",
  ...
  pa: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "ਪੂਰੇ ਹੋਏ UTC ਦਿਨ (ਦੋਵੇਂ ਤਾਰੀਖ਼ਾਂ ਸਮੇਤ)",
        daysInRangeLabel: "ਹੱਦ ਵਿਚਲੇ ਦਿਨ",
        description:
          "ਸਾਰੇ ਮਾਧਿਅਮਾਂ ਦੀ ਰੋਜ਼ਾਨਾ ਕੁੱਲ ਦੁਹਰਾਈ ਸਰਗਰਮੀ ਵੇਖੋ। ਪ੍ਰਕਾਸ਼ਿਤ ਅੰਕੜੇ ਸਿਰਫ਼ ਕੁੱਲ ਗਿਣਤੀਆਂ ਹਨ; ਇਨ੍ਹਾਂ ਵਿੱਚ ਕਾਰਡ ਦੀ ਸਮੱਗਰੀ, ਈਮੇਲ ਪਤੇ ਜਾਂ ਕਿਸੇ ਦਾ ਨਿੱਜੀ ਪੜ੍ਹਾਈ ਇਤਿਹਾਸ ਨਹੀਂ ਹੁੰਦਾ।",
        earlierDatesLabel: "ਪਹਿਲਾਂ ਦੀਆਂ ਤਾਰੀਖ਼ਾਂ",
        laterDatesLabel: "ਬਾਅਦ ਦੀਆਂ ਤਾਰੀਖ਼ਾਂ",
        latestDatesLabel: "ਸਭ ਤੋਂ ਨਵੀਆਂ ਤਾਰੀਖ਼ਾਂ",
        eyebrow: "ਸਰਗਰਮੀ",
        lastUpdatedLabel: "ਡਾਟਾ ਬਣਾਉਣ ਦਾ ਸਮਾਂ",
  ...
  ta: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "முடிவடைந்த UTC நாட்கள் (இரு தேதிகளும் உட்பட)",
        daysInRangeLabel: "வரம்பில் உள்ள நாட்கள்",
        description:
          "அனைத்து வழிகளிலிருந்தும் நாளாந்த மொத்த மீள்பயிற்சி செயல்பாட்டைப் பாருங்கள். வெளியிடப்படும் எண்கள் மொத்தக் கணக்குகள் மட்டுமே; அவை அட்டை உள்ளடக்கம், மின்னஞ்சல் முகவரிகள் அல்லது தனிநபர் படிப்பு வரலாற்றை வெளிப்படுத்துவதில்லை.",
        earlierDatesLabel: "முந்தைய தேதிகள்",
        laterDatesLabel: "பிந்தைய தேதிகள்",
        latestDatesLabel: "சமீபத்திய தேதிகள்",
        eyebrow: "செயல்பாடு",
        lastUpdatedLabel: "தரவு உருவாக்கப்பட்ட நேரம்",
        ...
        platformLabels: {
          agent: "ஏஜென்ட்",
          unattributed: "மூலம் தெரியவில்லை",
          android: "Android",
          ios: "iOS",
          web: "வலை",
        },
  ...
  te: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "పూర్తయిన UTC రోజులు (రెండు తేదీలతో సహా)",
        daysInRangeLabel: "పరిధిలోని రోజులు",
        description:
          "అన్ని మార్గాల రోజువారీ మొత్తం పునశ్చరణ కార్యకలాపాన్ని చూడండి. ప్రచురించిన గణాంకాలు మొత్తం లెక్కలు మాత్రమే; అవి కార్డు కంటెంట్‌ను, ఈమెయిల్ చిరునామాలను లేదా వ్యక్తిగత అధ్యయన చరిత్రను బహిర్గతం చేయవు.",
        earlierDatesLabel: "మునుపటి తేదీలు",
        laterDatesLabel: "తరువాతి తేదీలు",
        latestDatesLabel: "తాజా తేదీలు",
        eyebrow: "కార్యకలాపం",
        lastUpdatedLabel: "డేటా రూపొందించిన సమయం",
  ...
  ur: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "مکمل UTC دن (دونوں تاریخیں شامل)",
        daysInRangeLabel: "دورانیے کے دن",
        description:
          "تمام ذرائع کی روزانہ مجموعی دہرائی کی سرگرمی دیکھیں۔ شائع کردہ اعداد صرف مجموعی گنتیاں ہیں؛ ان سے کارڈ کا مواد، ای میل پتے یا کسی فرد کی مطالعاتی تاریخ ظاہر نہیں ہوتی۔",
        earlierDatesLabel: "پہلے کی تاریخیں",
        laterDatesLabel: "بعد کی تاریخیں",
        latestDatesLabel: "تازہ ترین تاریخیں",
        eyebrow: "سرگرمی",
        lastUpdatedLabel: "ڈیٹا تیار ہونے کا وقت",
  ...
  sw: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Siku kamili za UTC (pamoja na tarehe zote mbili)",
        daysInRangeLabel: "Siku katika kipindi",
        description:
          "Angalia shughuli ya jumla ya marudio ya kila siku kutoka njia zote. Takwimu zinazochapishwa ni jumla tu na haziweki wazi maudhui ya kadi, anwani za barua pepe wala historia ya masomo ya mtu binafsi.",
        earlierDatesLabel: "Tarehe za awali",
        laterDatesLabel: "Tarehe zinazofuata",
        latestDatesLabel: "Tarehe za karibuni",
        eyebrow: "Shughuli",
        lastUpdatedLabel: "Data ilitengenezwa",
        ...
        platformLabels: {
          agent: "Wakala",
          unattributed: "Chanzo hakijulikani",
          android: "Android",
          ios: "iOS",
          web: "Wavuti",
        },
  ...
  bg: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Завършени дни по UTC (включително)",
        daysInRangeLabel: "Дни в периода",
        description:
          "Вижте обобщената дневна активност по преговори от всички канали. Публикуваните числа са обобщени бройки и не разкриват съдържание на карти, имейл адреси или индивидуална история на ученето.",
        earlierDatesLabel: "Предишни дати",
        laterDatesLabel: "Следващи дати",
        latestDatesLabel: "Най-нови дати",
        eyebrow: "Активност",
        lastUpdatedLabel: "Данните са генерирани",
        ...
        platformLabels: {
          agent: "Агент",
          unattributed: "Без определен източник",
          android: "Android",
          ios: "iOS",
          web: "Уеб",
        },
  ...
  et: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Lõppenud UTC-päevad (kaasa arvatud)",
        daysInRangeLabel: "Päevi vahemikus",
        description:
          "Vaata koondatud igapäevast kordamisaktiivsust kõigist kanalitest. Avaldatud arvud on koondnäitajad ega avalda kaartide sisu, e-posti aadresse ega üksikute inimeste õpiajalugu.",
        earlierDatesLabel: "Varasemad kuupäevad",
        laterDatesLabel: "Hilisemad kuupäevad",
        latestDatesLabel: "Uusimad kuupäevad",
        eyebrow: "Aktiivsus",
        lastUpdatedLabel: "Andmed loodud",
  ...
  hr: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Završeni dani UTC-a (uključivo)",
        daysInRangeLabel: "Dana u rasponu",
        description:
          "Pogledajte zbirnu dnevnu aktivnost ponavljanja iz svih kanala. Objavljene brojke su zbirni podaci i ne otkrivaju sadržaj kartica, adrese e-pošte ni pojedinačnu povijest učenja.",
        earlierDatesLabel: "Raniji datumi",
        laterDatesLabel: "Kasniji datumi",
        latestDatesLabel: "Najnoviji datumi",
        eyebrow: "Aktivnost",
        lastUpdatedLabel: "Podaci generirani",
  ...
  is: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Heilir liðnir UTC-dagar (báðir endar meðtaldir)",
        daysInRangeLabel: "Dagar á tímabilinu",
        description:
          "Sjáðu samanlagða daglega upprifjun úr öllum leiðum. Birtar tölur eru heildarfjöldi og sýna hvorki efni spjalda, netföng né námssögu einstakra notenda.",
        earlierDatesLabel: "Fyrri dagsetningar",
        laterDatesLabel: "Síðari dagsetningar",
        latestDatesLabel: "Nýjustu dagsetningar",
        eyebrow: "Virkni",
        lastUpdatedLabel: "Gögn búin til",
  ...
  lt: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Pasibaigusios UTC dienos (imtinai)",
        daysInRangeLabel: "Dienų laikotarpyje",
        description:
          "Pažiūrėkite bendrą kasdienį kartojimo aktyvumą iš visų kanalų. Skelbiami skaičiai yra suvestiniai ir neatskleidžia kortelių turinio, el. pašto adresų ar atskirų žmonių mokymosi istorijos.",
        earlierDatesLabel: "Ankstesnės datos",
        laterDatesLabel: "Vėlesnės datos",
        latestDatesLabel: "Naujausios datos",
        eyebrow: "Aktyvumas",
        lastUpdatedLabel: "Duomenys sugeneruoti",
  ...
  lv: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Pabeigtas UTC dienas (ieskaitot)",
        daysInRangeLabel: "Dienu skaits diapazonā",
        description:
          "Apskati kopējo ikdienas atkārtošanas aktivitāti no visiem kanāliem. Publicētie skaitļi ir apkopoti dati un neatklāj kartīšu saturu, e-pasta adreses vai atsevišķu cilvēku mācīšanās vēsturi.",
        earlierDatesLabel: "Agrāki datumi",
        laterDatesLabel: "Vēlāki datumi",
        latestDatesLabel: "Jaunākie datumi",
        eyebrow: "Aktivitāte",
        lastUpdatedLabel: "Dati ģenerēti",
  ...
  sk: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Ukončené dni UTC (vrátane)",
        daysInRangeLabel: "Počet dní v období",
        description:
          "Pozrite si súhrnnú dennú aktivitu opakovania zo všetkých kanálov. Zverejnené údaje sú súhrnné počty a neodhaľujú obsah kartičiek, e-mailové adresy ani históriu učenia jednotlivcov.",
        earlierDatesLabel: "Skoršie dátumy",
        laterDatesLabel: "Neskoršie dátumy",
        latestDatesLabel: "Najnovšie dátumy",
        eyebrow: "Aktivita",
        lastUpdatedLabel: "Údaje vytvorené",
  ...
  sl: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Zaključeni dnevi UTC (vključno)",
        daysInRangeLabel: "Število dni v obdobju",
        description:
          "Oglejte si skupno dnevno dejavnost ponavljanja iz vseh kanalov. Objavljene številke so skupni seštevki in ne razkrivajo vsebine kartic, e-poštnih naslovov ali zgodovine učenja posameznikov.",
        earlierDatesLabel: "Prejšnji datumi",
        laterDatesLabel: "Poznejši datumi",
        latestDatesLabel: "Najnovejši datumi",
        eyebrow: "Dejavnost",
        lastUpdatedLabel: "Podatki ustvarjeni",
  ...
  zu: {
    ...
    home: {
      activity: {
        ...
        dateRangeLabel: "Izinsuku eziphelele ze-UTC (zihlanganisa zombili izinsuku)",
        daysInRangeLabel: "Izinsuku ebangeni",
        description:
          "Bona umsebenzi wokubuyekeza wansuku zonke ohlanganisiwe kuzo zonke izindlela. Izibalo ezishicilelwayo zingamanani ahlanganisiwe futhi azivezi okuqukethwe kwamakhadi, amakheli e-imeyili noma umlando wokufunda womuntu ngamunye.",
        earlierDatesLabel: "Izinsuku zangaphambilini",
        laterDatesLabel: "Izinsuku ezilandelayo",
        latestDatesLabel: "Izinsuku zakamuva",
        eyebrow: "Umsebenzi",
        lastUpdatedLabel: "Idatha yenziwe",
