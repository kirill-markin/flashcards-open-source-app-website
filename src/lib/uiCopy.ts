...
const UI_COPY_BY_LOCALE: Readonly<Record<AppLocale, AppUiCopy>> = {
  en: {
    ...
    analyticsConsentWithdrawal: {
      close: "Close",
      collectionDescription: "When this is off, this site sends nothing about your visits at all, with or without the cookie. This site has no accounts, so the choice is kept in this browser and applies only here. The analytics cookie choice is available while collection is on.",
  ...
  es: {
    ...
    analyticsConsentWithdrawal: {
      close: "Cerrar",
      collectionDescription: "Cuando está desactivado, este sitio no envía nada sobre tus visitas, con cookie o sin ella. Este sitio no tiene cuentas, así que la elección se guarda en este navegador y solo se aplica aquí. La elección sobre las cookies de analítica está disponible mientras la recopilación está activada.",
  ...
  ar: {
    ...
    analyticsConsentWithdrawal: {
      close: "إغلاق",
      collectionDescription: "عند إيقافه، لا يرسل هذا الموقع أي شيء عن زياراتك إطلاقًا، سواء بوجود ملف تعريف الارتباط أو بدونه. لا توجد حسابات في هذا الموقع، لذلك يُحفظ هذا الاختيار في هذا المتصفح ويسري هنا فقط. ويتوفر الاختيار الخاص بملفات تعريف الارتباط التحليلية ما دام الجمع مفعّلًا.",
  ...
  de: {
    ...
    analyticsConsentWithdrawal: {
      close: "Schließen",
      collectionDescription: "Wenn dies aus ist, sendet diese Website gar nichts über deine Besuche, mit oder ohne Cookie. Diese Website hat keine Konten, also bleibt die Entscheidung in diesem Browser und gilt nur hier. Die Entscheidung über Analyse-Cookies steht zur Verfügung, solange die Erfassung an ist.",
  ...
  hi: {
    ...
    analyticsConsentWithdrawal: {
      close: "बंद करें",
      collectionDescription: "बंद होने पर यह साइट आपकी विज़िट के बारे में कुछ भी नहीं भेजती, कुकी के साथ हो या बिना। इस साइट पर कोई खाता नहीं है, इसलिए यह चुनाव इसी ब्राउज़र में रहता है और सिर्फ़ यहीं लागू होता है। एनालिटिक्स कुकी का विकल्प तभी उपलब्ध रहता है जब संग्रह चालू हो।",
  ...
  ja: {
    ...
    analyticsConsentWithdrawal: {
      close: "閉じる",
      collectionDescription: "オフのとき、このサイトは Cookie の有無にかかわらず、あなたの訪問について何も送信しません。このサイトにはアカウントがないため、この選択はこのブラウザーに保存され、ここでのみ適用されます。 分析 Cookie の選択は、収集がオンのあいだ利用できます。",
  ...
  fr: {
    ...
    analyticsConsentWithdrawal: {
      close: "Fermer",
      collectionDescription: "Quand c'est désactivé, ce site n'envoie rien du tout sur vos visites, avec ou sans cookie. Ce site n'a pas de comptes, donc le choix reste dans ce navigateur et ne s'applique qu'ici. Le choix concernant les cookies d'analyse est disponible tant que la collecte est activée.",
  ...
  pt: {
    ...
    analyticsConsentWithdrawal: {
      close: "Fechar",
      collectionDescription: "Quando está desligado, este site não envia nada sobre as suas visitas, com ou sem cookie. Este site não tem contas, então a escolha fica neste navegador e vale apenas aqui. A escolha sobre os cookies de analítica fica disponível enquanto a recolha estiver ligada.",
  ...
  ru: {
    ...
    analyticsConsentWithdrawal: {
      close: "Закрыть",
      collectionDescription: "Когда выключено, сайт вообще ничего не отправляет о ваших посещениях — с cookie или без. На сайте нет аккаунтов, поэтому выбор хранится в этом браузере и действует только здесь. Выбор по аналитическим cookie доступен, пока сбор включён.",
  ...
  zh: {
    ...
    analyticsConsentWithdrawal: {
      close: "关闭",
      collectionDescription: "关闭后，无论有没有 Cookie，本网站都不会发送任何关于你的访问的信息。本网站没有账号，因此该选择保存在此浏览器中，仅在这里生效。 只要收集处于开启状态，就可以选择是否允许分析 Cookie。",
  ...
  it: {
    ...
    analyticsConsentWithdrawal: {
      close: "Chiudi",
      collectionDescription: "Quando è disattivato, questo sito non invia nulla sulle tue visite, con o senza cookie. Questo sito non ha account, quindi la scelta resta in questo browser e vale solo qui. La scelta sui cookie di analisi è disponibile finché la raccolta è attiva.",
  ...
  ko: {
    ...
    analyticsConsentWithdrawal: {
      close: "닫기",
      collectionDescription: "꺼져 있으면 이 사이트는 쿠키가 있든 없든 방문에 대해 아무것도 전송하지 않습니다. 이 사이트에는 계정이 없으므로 이 선택은 이 브라우저에 저장되며 여기에서만 적용됩니다. 분석 쿠키 선택은 수집이 켜져 있는 동안 이용할 수 있습니다.",
  ...
  id: {
    ...
    analyticsConsentWithdrawal: {
      close: "Tutup",
      collectionDescription: "Saat nonaktif, situs ini tidak mengirim apa pun tentang kunjungan Anda, dengan atau tanpa cookie. Situs ini tidak memiliki akun, jadi pilihan ini disimpan di peramban ini dan hanya berlaku di sini. Pilihan cookie analitik tersedia selama pengumpulan aktif.",
  ...
  tr: {
    ...
    analyticsConsentWithdrawal: {
      close: "Kapat",
      collectionDescription: "Kapalıyken bu site, çerez olsun olmasın, ziyaretleriniz hakkında hiçbir şey göndermez. Bu sitede hesap yoktur, bu nedenle seçim bu tarayıcıda saklanır ve yalnızca burada geçerlidir. Analiz çerezi seçimi, toplama açıkken kullanılabilir.",
  ...
  nl: {
    ...
    analyticsConsentWithdrawal: {
      close: "Sluiten",
      collectionDescription: "Als dit uit staat, stuurt deze site helemaal niets over je bezoeken, met of zonder cookie. Deze site heeft geen accounts, dus de keuze blijft in deze browser en geldt alleen hier. De keuze over analytische cookies is beschikbaar zolang het verzamelen aan staat.",
  ...
  pl: {
    ...
    analyticsConsentWithdrawal: {
      close: "Zamknij",
      collectionDescription: "Gdy jest wyłączone, witryna nie wysyła niczego o Twoich wizytach — z plikiem cookie czy bez niego. Ta witryna nie ma kont, więc wybór zostaje w tej przeglądarce i działa tylko tutaj. Wybór dotyczący analitycznych plików cookie jest dostępny, gdy zbieranie jest włączone.",
  ...
  vi: {
    ...
    analyticsConsentWithdrawal: {
      close: "Đóng",
      collectionDescription: "Khi tắt, trang web không gửi bất kỳ thông tin nào về lượt truy cập của bạn, dù có cookie hay không. Trang web này không có tài khoản, nên lựa chọn được lưu trong trình duyệt này và chỉ áp dụng ở đây. Lựa chọn về cookie phân tích khả dụng khi việc thu thập đang bật.",
  ...
  th: {
    ...
    analyticsConsentWithdrawal: {
      close: "ปิด",
      collectionDescription: "เมื่อปิดอยู่ เว็บไซต์นี้จะไม่ส่งข้อมูลใดเกี่ยวกับการเข้าชมของคุณเลย ไม่ว่าจะมีคุกกี้หรือไม่ก็ตาม เว็บไซต์นี้ไม่มีบัญชีผู้ใช้ ตัวเลือกนี้จึงถูกเก็บไว้ในเบราว์เซอร์นี้และมีผลที่นี่เท่านั้น ตัวเลือกคุกกี้สำหรับการวิเคราะห์จะใช้ได้เมื่อการเก็บข้อมูลเปิดอยู่",
  ...
  uk: {
    ...
    analyticsConsentWithdrawal: {
      close: "Закрити",
      collectionDescription: "Коли вимкнено, сайт не надсилає взагалі нічого про ваші відвідування — з cookie чи без. На сайті немає облікових записів, тож вибір зберігається в цьому браузері й діє лише тут. Вибір щодо аналітичних cookie доступний, поки збір увімкнено.",
  ...
  he: {
    ...
    analyticsConsentWithdrawal: {
      close: "סגירה",
      collectionDescription: "כשזה כבוי, האתר לא שולח שום דבר על הביקורים שלך, עם עוגייה או בלעדיה. באתר הזה אין חשבונות, ולכן הבחירה נשמרת בדפדפן הזה וחלה רק כאן. הבחירה בעוגיות אנליטיקה זמינה כל עוד האיסוף פעיל.",
  ...
  sv: {
    ...
    analyticsConsentWithdrawal: {
      close: "Stäng",
      collectionDescription: "När det här är av skickar den här webbplatsen ingenting alls om dina besök, med eller utan cookie. Den här webbplatsen har inga konton, så valet stannar i den här webbläsaren och gäller bara här. Valet om analyscookies är tillgängligt så länge insamlingen är på.",
  ...
  da: {
    ...
    analyticsConsentWithdrawal: {
      close: "Luk",
      collectionDescription: "Når det her er slået fra, sender dette site slet ikke noget om dine besøg, med eller uden cookie. Dette site har ingen konti, så valget bliver i denne browser og gælder kun her. Valget om analysecookies er tilgængeligt, så længe indsamlingen er slået til.",
  ...
  nb: {
    ...
    analyticsConsentWithdrawal: {
      close: "Sulje",
      collectionDescription: "Kun tämä on pois päältä, tämä sivusto ei lähetä käynneistäsi yhtään mitään, evästeen kanssa tai ilman. Tällä sivustolla ei ole tilejä, joten valinta jää tähän selaimeen ja on voimassa vain täällä. Analytiikkaevästeitä koskeva valinta on käytettävissä, kun keruu on päällä.",
  ...
  cs: {
    ...
    analyticsConsentWithdrawal: {
      close: "Zavřít",
      collectionDescription: "Když je tohle vypnuté, tento web neodesílá o vašich návštěvách vůbec nic, s cookie i bez ní. Tento web nemá účty, takže volba zůstává v tomto prohlížeči a platí jen tady. Volba analytických cookie je dostupná, dokud je sběr zapnutý.",
  ...
  el: {
    ...
    analyticsConsentWithdrawal: {
      close: "Κλείσιμο",
      collectionDescription: "Όταν αυτό είναι ανενεργό, ο ιστότοπος δεν στέλνει απολύτως τίποτα για τις επισκέψεις σας, με ή χωρίς cookie. Αυτός ο ιστότοπος δεν έχει λογαριασμούς, οπότε η επιλογή μένει σε αυτό το πρόγραμμα περιήγησης και ισχύει μόνο εδώ. Η επιλογή για τα cookie ανάλυσης είναι διαθέσιμη όσο η συλλογή είναι ενεργή.",
  ...
  ro: {
    ...
    analyticsConsentWithdrawal: {
      close: "Închide",
      collectionDescription: "Când este dezactivat, acest site nu trimite nimic despre vizitele tale, cu sau fără cookie. Acest site nu are conturi, așa că alegerea rămâne în acest browser și se aplică doar aici. Alegerea privind cookie-urile de analiză este disponibilă cât timp colectarea este activată.",
  ...
  hu: {
    ...
    analyticsConsentWithdrawal: {
      close: "Bezárás",
      collectionDescription: "Ha ez ki van kapcsolva, ez az oldal semmit sem küld a látogatásaidról, sütivel vagy anélkül. Ezen az oldalon nincsenek fiókok, ezért a döntés ebben a böngészőben marad, és csak itt érvényes. Az analitikai sütikre vonatkozó döntés addig érhető el, amíg a gyűjtés be van kapcsolva.",
  ...
  fa: {
    ...
    analyticsConsentWithdrawal: {
      close: "بستن",
      collectionDescription: "وقتی این خاموش باشد، این سایت هیچ چیزی دربارهٔ بازدیدهای شما نمی‌فرستد، با کوکی یا بدون آن. این سایت حساب کاربری ندارد، بنابراین این انتخاب در همین مرورگر ذخیره می‌شود و فقط اینجا اعمال می‌شود. انتخاب مربوط به کوکی‌های تحلیلی تا زمانی که جمع‌آوری روشن باشد در دسترس است.",
  ...
  ca: {
    ...
    analyticsConsentWithdrawal: {
      close: "Tanca",
      collectionDescription: "Quan això està desactivat, aquest lloc no envia res sobre les teves visites, amb galeta o sense. Aquest lloc no té comptes, així que l'elecció es desa en aquest navegador i només s'aplica aquí. L'elecció sobre les galetes d'analítica està disponible mentre la recollida estigui activada.",
  ...
  bn: {
    ...
    analyticsConsentWithdrawal: {
      close: "বন্ধ করুন",
      collectionDescription: "এটি বন্ধ থাকলে এই সাইট আপনার ভিজিট সম্পর্কে কিছুই পাঠায় না, কুকি থাকুক বা না থাকুক। এই সাইটে কোনো অ্যাকাউন্ট নেই, তাই এই পছন্দ এই ব্রাউজারেই থাকে এবং কেবল এখানেই প্রযোজ্য। বিশ্লেষণ কুকির পছন্দটি সংগ্রহ চালু থাকা অবস্থায় পাওয়া যায়।",
  ...
  gu: {
    ...
    analyticsConsentWithdrawal: {
      close: "બંધ કરો",
      collectionDescription: "આ બંધ હોય ત્યારે આ સાઇટ તમારી મુલાકાતો વિશે કંઈ જ મોકલતી નથી, કૂકી હોય કે ન હોય. આ સાઇટ પર કોઈ ખાતાં નથી, તેથી આ પસંદગી આ બ્રાઉઝરમાં જ રહે છે અને ફક્ત અહીં જ લાગુ પડે છે. વિશ્લેષણ કૂકીની પસંદગી સંગ્રહ ચાલુ હોય ત્યારે ઉપલબ્ધ હોય છે.",
  ...
  kn: {
    ...
    analyticsConsentWithdrawal: {
      close: "ಮುಚ್ಚಿ",
      collectionDescription: "ಇದು ಆಫ್ ಆಗಿದ್ದಾಗ ಈ ಸೈಟ್ ನಿಮ್ಮ ಭೇಟಿಗಳ ಬಗ್ಗೆ ಏನನ್ನೂ ಕಳುಹಿಸುವುದಿಲ್ಲ, ಕುಕೀ ಇದ್ದರೂ ಇಲ್ಲದಿದ್ದರೂ. ಈ ಸೈಟ್‌ನಲ್ಲಿ ಖಾತೆಗಳಿಲ್ಲ, ಆದ್ದರಿಂದ ಈ ಆಯ್ಕೆ ಈ ಬ್ರೌಸರ್‌ನಲ್ಲಿಯೇ ಉಳಿಯುತ್ತದೆ ಮತ್ತು ಇಲ್ಲಿ ಮಾತ್ರ ಅನ್ವಯಿಸುತ್ತದೆ. ವಿಶ್ಲೇಷಣಾ ಕುಕೀ ಆಯ್ಕೆ ಸಂಗ್ರಹಣೆ ಆನ್ ಆಗಿರುವಾಗ ಲಭ್ಯವಿರುತ್ತದೆ.",
  ...
  ml: {
    ...
    analyticsConsentWithdrawal: {
      close: "അടയ്ക്കുക",
      collectionDescription: "ഇത് ഓഫ് ആയിരിക്കുമ്പോൾ, കുക്കി ഉണ്ടെങ്കിലും ഇല്ലെങ്കിലും, ഈ സൈറ്റ് നിങ്ങളുടെ സന്ദർശനങ്ങളെക്കുറിച്ച് ഒന്നും അയയ്ക്കുന്നില്ല. ഈ സൈറ്റിൽ അക്കൗണ്ടുകളില്ല, അതിനാൽ ഈ തിരഞ്ഞെടുപ്പ് ഈ ബ്രൗസറിൽ തന്നെ സൂക്ഷിക്കുന്നു, ഇവിടെ മാത്രം ബാധകമാകുന്നു. അനലിറ്റിക്സ് കുക്കി സംബന്ധിച്ച തിരഞ്ഞെടുപ്പ് ശേഖരണം ഓൺ ആയിരിക്കുമ്പോൾ ലഭ്യമാണ്.",
  ...
  mr: {
    ...
    analyticsConsentWithdrawal: {
      close: "बंद करा",
      collectionDescription: "हे बंद असताना ही साइट तुमच्या भेटींबद्दल काहीही पाठवत नाही, कुकी असो वा नसो. या साइटवर खाती नाहीत, त्यामुळे ही निवड याच ब्राउझरमध्ये राहते आणि फक्त इथेच लागू होते. विश्लेषण कुकीची निवड संकलन चालू असताना उपलब्ध असते.",
  ...
  pa: {
    ...
    analyticsConsentWithdrawal: {
      close: "ਬੰਦ ਕਰੋ",
      collectionDescription: "ਜਦੋਂ ਇਹ ਬੰਦ ਹੁੰਦਾ ਹੈ, ਇਹ ਸਾਈਟ ਤੁਹਾਡੀਆਂ ਵਿਜ਼ਿਟਾਂ ਬਾਰੇ ਕੁਝ ਵੀ ਨਹੀਂ ਭੇਜਦੀ, ਕੂਕੀ ਹੋਵੇ ਜਾਂ ਨਾ ਹੋਵੇ। ਇਸ ਸਾਈਟ ਉੱਤੇ ਕੋਈ ਖਾਤੇ ਨਹੀਂ ਹਨ, ਇਸ ਲਈ ਇਹ ਚੋਣ ਇਸੇ ਬ੍ਰਾਊਜ਼ਰ ਵਿੱਚ ਰਹਿੰਦੀ ਹੈ ਅਤੇ ਸਿਰਫ਼ ਇੱਥੇ ਹੀ ਲਾਗੂ ਹੁੰਦੀ ਹੈ। ਵਿਸ਼ਲੇਸ਼ਣ ਕੂਕੀ ਦੀ ਚੋਣ ਉਦੋਂ ਉਪਲਬਧ ਹੁੰਦੀ ਹੈ ਜਦੋਂ ਇਕੱਤਰ ਕਰਨਾ ਚਾਲੂ ਹੋਵੇ।",
  ...
  te: {
    ...
    analyticsConsentWithdrawal: {
      close: "మూసివేయండి",
      collectionDescription: "ఇది ఆఫ్‌లో ఉన్నప్పుడు, కుకీ ఉన్నా లేకున్నా, ఈ సైట్ మీ సందర్శనల గురించి ఏదీ పంపదు. ఈ సైట్‌లో ఖాతాలు లేవు, కాబట్టి ఈ ఎంపిక ఈ బ్రౌజర్‌లోనే ఉంటుంది, ఇక్కడ మాత్రమే వర్తిస్తుంది. విశ్లేషణ కుకీ ఎంపిక సేకరణ ఆన్‌లో ఉన్నప్పుడు అందుబాటులో ఉంటుంది.",
  ...
  ur: {
    ...
    analyticsConsentWithdrawal: {
      close: "بند کریں",
      collectionDescription: "جب یہ بند ہو تو یہ سائٹ آپ کے وزٹس کے بارے میں کچھ بھی نہیں بھیجتی، کوکی ہو یا نہ ہو۔ اس سائٹ پر کوئی اکاؤنٹ نہیں ہے، اس لیے یہ انتخاب اسی براؤزر میں رہتا ہے اور صرف یہیں لاگو ہوتا ہے۔ تجزیاتی کوکی کا انتخاب اسی وقت دستیاب ہوتا ہے جب جمع کرنا آن ہو۔",
  ...
  sw: {
    ...
    analyticsConsentWithdrawal: {
      close: "Funga",
      collectionDescription: "Inapozimwa, tovuti hii haitumi chochote kuhusu ziara zako, iwe kuna kidakuzi au la. Tovuti hii haina akaunti, kwa hivyo chaguo hili huhifadhiwa katika kivinjari hiki na hutumika hapa pekee. Chaguo la vidakuzi vya uchanganuzi linapatikana wakati ukusanyaji umewashwa.",
  ...
  bg: {
    ...
    analyticsConsentWithdrawal: {
      close: "Затваряне",
      collectionDescription: "Когато е изключено, сайтът не изпраща нищо за посещенията ви — със или без бисквитка. Този сайт няма акаунти, затова изборът остава в този браузър и важи само тук. Изборът за аналитичните бисквитки е достъпен, докато събирането е включено.",
  ...
  et: {
    ...
    analyticsConsentWithdrawal: {
      close: "Sulge",
      collectionDescription: "Kui see on väljas, ei saada see sait sinu külastuste kohta üldse midagi, küpsisega või ilma. Sellel saidil pole kontosid, seega jääb valik sellesse brauserisse ja kehtib ainult siin. Analüütikaküpsiste valik on saadaval siis, kui kogumine on sees.",
  ...
  hr: {
    ...
    analyticsConsentWithdrawal: {
      close: "Zatvori",
      collectionDescription: "Kad je ovo isključeno, stranica ne šalje baš ništa o vašim posjetima, s kolačićem ili bez njega. Ova stranica nema račune, pa izbor ostaje u ovom pregledniku i vrijedi samo ovdje. Izbor o analitičkim kolačićima dostupan je dok je prikupljanje uključeno.",
  ...
  is: {
    ...
    analyticsConsentWithdrawal: {
      close: "Loka",
      collectionDescription: "Þegar slökkt er á þessu sendir vefurinn alls ekkert um heimsóknir þínar, með vafraköku eða án hennar. Þessi vefur er ekki með aðganga, svo valið helst í þessum vafra og gildir aðeins hér. Valið um vafrakökur fyrir greiningu er í boði á meðan kveikt er á söfnun.",
  ...
  lt: {
    ...
    analyticsConsentWithdrawal: {
      close: "Uždaryti",
      collectionDescription: "Kai tai išjungta, svetainė nesiunčia visiškai nieko apie jūsų apsilankymus – su slapuku ar be jo. Ši svetainė neturi paskyrų, todėl pasirinkimas lieka šioje naršyklėje ir galioja tik čia. Analitikos slapukų pasirinkimas pasiekiamas, kol rinkimas įjungtas.",
  ...
  lv: {
    ...
    analyticsConsentWithdrawal: {
      close: "Aizvērt",
      collectionDescription: "Kad tas ir izslēgts, vietne nesūta neko par taviem apmeklējumiem – ar sīkdatni vai bez tās. Šai vietnei nav kontu, tāpēc izvēle paliek šajā pārlūkā un ir spēkā tikai šeit. Analītikas sīkdatņu izvēle ir pieejama, kamēr vākšana ir ieslēgta.",
  ...
  sk: {
    ...
    analyticsConsentWithdrawal: {
      close: "Zavrieť",
      collectionDescription: "Keď je toto vypnuté, stránka neodosiela o vašich návštevách vôbec nič, s cookie aj bez neho. Táto stránka nemá účty, takže voľba zostáva v tomto prehliadači a platí len tu. Voľba analytických cookie je dostupná, kým je zber zapnutý.",
  ...
  sl: {
    ...
    analyticsConsentWithdrawal: {
      close: "Zapri",
      collectionDescription: "Ko je to izklopljeno, ta stran o vaših obiskih ne pošlje popolnoma ničesar, s piškotkom ali brez njega. Ta stran nima računov, zato izbira ostane v tem brskalniku in velja samo tukaj. Izbira glede analitičnih piškotkov je na voljo, dokler je zbiranje vklopljeno.",
